...
export const ARTICLES_24240: Article[] = [
  {
    id: 'art-24240-1',
    lawId: 'ley-24240',
    number: '1',
    ...
    examples: [
      ...
      'Un familiar que usa el celular comprado por otro también está protegido (equiparado).',
      'Una empresa que compra materiales para fabricar no está cubierta por esta ley.',
    ],
    relatedArticles: ['art-24240-2', 'art-24240-3'],
    jurisprudence: [
      'CSJN — "Recurso de hecho deducido por la demandada en la causa Mosca, Hugo Arnaldo c/ Buenos Aires, Provincia de" (2007): amplió el concepto de consumidor.',
    ],
    regulations: ['Decreto 1798/1994 (reglamentario)'],
    keywords: ['consumidor', 'usuario', 'destinatario final', 'relación de consumo'],
    order: 1,
    segments: [
      {
        id: 'seg-24240-1-1',
        ...
        practicalExample:
          'Una persona que compra alimentos en el supermercado para su familia es consumidor y está protegida por esta ley.',
        references: [],
        order: 1,
      },
      {
        ...
        practicalExample:
          'El hijo que usa el plan de internet contratado por su padre también está protegido, aunque no haya firmado el contrato.',
        references: [],
        order: 2,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un médico que atiende pacientes no está sujeto a esta ley, pero si publica publicidad engañosa sobre sus servicios, sí.',
    ],
    relatedArticles: ['art-24240-1', 'art-24240-3'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994 (reglamentario)'],
    keywords: ['proveedor', 'fabricante', 'importador', 'distribuidor', 'profesional liberal'],
    order: 2,
    segments: [
      {
        id: 'seg-24240-2-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-1', 'art-24240-37'],
    jurisprudence: [],
    regulations: [],
    keywords: ['relación de consumo', 'in dubio pro consumidor', 'interpretación'],
    order: 3,
    segments: [
      {
        id: 'seg-24240-3-1',
        ...
        practicalExample:
          'Un contrato de servicio de internet tiene una cláusula confusa sobre la velocidad garantizada. El juez debe interpretarla de la manera más favorable al consumidor.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La información digital reemplaza al papel solo si el consumidor lo elige expresamente.',
      'El incumplimiento puede dar lugar a sanciones administrativas.',
    ],
    examples: [
      'Una empresa de telefonía debe informar claramente el costo del plan, franquicias y cargos adicionales.',
      'No puede cobrar por enviar el resumen de cuenta en papel si el cliente no optó por el formato digital.',
    ],
    relatedArticles: ['art-24240-5', 'art-24240-10'],
    jurisprudence: [],
    regulations: [],
    keywords: ['información al consumidor', 'claridad', 'gratuidad', 'soporte físico'],
    order: 4,
    segments: [
      {
        id: 'seg-24240-4-1',
        ...
        practicalExample:
          'Un banco debe informar claramente la tasa de interés, comisiones y cargos de una tarjeta de crédito antes de que el cliente la acepte.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Si un producto es peligroso en condiciones normales de uso, el proveedor puede ser responsable por los daños.',
    ],
    examples: [
      'Un electrodoméstico que se incendia con uso normal viola este artículo.',
      'Un medicamento que causa daños si se toma en la dosis recomendada también viola este artículo.',
    ],
    relatedArticles: ['art-24240-6', 'art-24240-40'],
    jurisprudence: [],
    regulations: [],
    keywords: ['seguridad', 'salud', 'integridad física', 'producto seguro'],
    order: 5,
    segments: [
      {
        id: 'seg-24240-5-1',
        ...
        practicalExample:
          'Una silla que se rompe bajo el peso normal de una persona adulta, causando una caída, constituye un producto peligroso bajo este artículo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El negarse a cumplir una oferta vigente puede ser sancionado.',
      'La revocación debe hacerse de igual modo que la oferta (mismo medio y alcance).',
    ],
    examples: [
      'Un supermercado publica una oferta por un producto a precio promocional: debe vendérselo a ese precio a todos los que lo soliciten mientras dure la oferta.',
      'Si un negocio quiere revocar una oferta publicada en redes sociales, debe hacerlo también por redes sociales.',
    ],
    relatedArticles: ['art-24240-8', 'art-24240-10bis'],
    jurisprudence: [],
    regulations: [],
    keywords: ['oferta', 'publicidad', 'vinculante', 'revocación'],
    order: 6,
    segments: [
      {
        id: 'seg-24240-7-1',
        ...
        practicalExample:
          '«50% off en todos los electrodomésticos del viernes al domingo»: si el cliente llega el sábado, el proveedor no puede negarse a vender al precio promocional.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El consumidor puede exigir lo prometido en la publicidad aunque no esté en el contrato.',
    ],
    examples: [
      'Un banco publicita que regala millas al usar su tarjeta: ese beneficio integra el contrato, aunque las condiciones escritas del contrato no lo mencionen.',
      'Una inmobiliaria publica en su aviso que el departamento incluye cochera: debe entregar la cochera aunque el boleto de compraventa no lo mencione.',
    ],
    relatedArticles: ['art-24240-7', 'art-24240-37'],
    jurisprudence: [],
    regulations: [],
    keywords: ['publicidad', 'contrato', 'oferta vinculante', 'integración contractual'],
    order: 7,
    segments: [
      {
        id: 'seg-24240-8-1',
        ...
        practicalExample:
          'Una automotriz publicita que todos sus autos incluyen alarma de fábrica. Un comprador puede exigir la alarma aunque el contrato de compraventa no la mencione.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El proveedor no puede excluir la garantía legal ni limitarla a un plazo menor.',
      'Los gastos de flete y reparación durante la garantía son a cargo del proveedor.',
    ],
    examples: [
      'Un televisor comprado nuevo que falla a los 4 meses está dentro de garantía (6 meses) y el proveedor debe repararlo o reemplazarlo sin costo.',
      'Un auto usado que se vende con 3 meses de garantía legal: si falla en el mes 2, la garantía cubre la reparación.',
    ],
    relatedArticles: ['art-24240-12', 'art-24240-13', 'art-24240-17'],
    jurisprudence: [],
    regulations: [],
    keywords: ['garantía legal', '6 meses', 'bien mueble', 'defecto', 'vicio'],
    order: 8,
    segments: [
      {
        id: 'seg-24240-11-1',
        ...
        practicalExample:
          'Compro un lavarropas nuevo. Si deja de funcionar a los 5 meses, el vendedor debe repararlo sin cargo, porque aún está dentro de los 6 meses de garantía.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'No requiere invocar causa: el consumidor puede ejercerlo sin dar explicaciones.',
      'Los gastos de devolución son a cargo del proveedor.',
      'Es irrenunciable: ninguna cláusula puede eliminar este derecho.',
    ],
    examples: [
      'Compro un producto por Instagram: si en 10 días me arrepiento, puedo devolverlo sin costo.',
      'Una empresa me vende por teléfono un seguro de vida: tengo 10 días para cancelarlo sin penalidad.',
    ],
    relatedArticles: ['art-24240-32', 'art-24240-33', 'art-24240-35'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derecho de arrepentimiento', '10 días', 'venta a distancia', 'revocación', 'e-commerce'],
    order: 9,
    segments: [
      {
        id: 'seg-24240-34-1',
        ...
        practicalExample:
          'Compro una campera por MercadoLibre. La recibo el 1 de mayo. Puedo devolverla hasta el 11 de mayo sin dar explicaciones y sin pagar el flete de devolución.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      '«El consumidor renuncia a reclamar por garantía»: cláusula nula.',
      '«El consumidor debe probar que el producto estaba defectuoso»: cláusula nula (invierte la carga de la prueba).',
    ],
    relatedArticles: ['art-24240-3', 'art-24240-38'],
    jurisprudence: [],
    regulations: [],
    keywords: ['cláusulas abusivas', 'nulidad', 'contrato de adhesión', 'carga de la prueba'],
    order: 10,
    segments: [
      {
        id: 'seg-24240-37-1',
        ...
        practicalExample:
          'El contrato de un servicio de streaming dice: «No nos responsabilizamos por interrupciones del servicio». Esa cláusula es abusiva y nula.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Una marca blanca de un supermercado que resulta defectuosa: el supermercado responde por haber puesto su marca.',
    ],
    relatedArticles: ['art-24240-5', 'art-24240-13'],
    jurisprudence: [],
    regulations: [],
    keywords: ['responsabilidad solidaria', 'cadena de comercialización', 'daño', 'vicio', 'riesgo'],
    order: 11,
    segments: [
      {
        id: 'seg-24240-40-1',
        ...
        practicalExample:
          'Compro un juguete en una juguetería. El juguete tiene una pieza peligrosa fabricada en China. Puedo demandar a la juguetería, al importador y al fabricante chino (si está en Argentina) por el daño que causó.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un comercio que vende artículos sin precio visible puede recibir apercibimiento o multa.',
    ],
    relatedArticles: ['art-24240-49', 'art-24240-52bis'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sanciones', 'multa', 'clausura', 'decomiso', 'infracción'],
    order: 12,
    segments: [
      {
        id: 'seg-24240-47-1',
  ...
  },
  {
    ...
    examples: [
      ...
      'Una asociación de consumidores puede demandar a una empresa en nombre de todos los afectados por una práctica abusiva.',
    ],
    relatedArticles: ['art-24240-52bis', 'art-24240-53', 'art-24240-55'],
    jurisprudence: [],
    regulations: [],
    keywords: ['acción judicial', 'justicia gratuita', 'legitimación', 'defensor del pueblo', 'Ministerio Público'],
    order: 13,
    segments: [
      {
        id: 'seg-24240-52-1',
        ...
        practicalExample:
          'Me vendieron un auto con vicios ocultos. Puedo demandar al concesionario ante el juzgado sin pagar tasa de justicia ni honorarios previos.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Una aseguradora que niega sistemáticamente cobertura sabiendo que procede puede ser condenada a daño punitivo.',
    ],
    relatedArticles: ['art-24240-47', 'art-24240-52'],
    jurisprudence: [
      'CSJN — "Teijeiro c/ Cervecería y Maltería Quilmes" (2012): el daño punitivo requiere una conducta gravemente reprochable, no cualquier incumplimiento.',
    ],
    regulations: [],
    keywords: ['daño punitivo', 'multa civil', 'sanción ejemplar', 'conducta reprochable'],
    order: 14,
    segments: [
      {
        id: 'seg-24240-52bis-1',
        lawId: 'ley-24240',
        ...
        practicalExample:
          'Una empresa de medicina prepaga demora sistemáticamente las autorizaciones de cirugías urgentes. El juez le impone daño punitivo además de ordenar la cobertura y pagar los gastos que el paciente tuvo que adelantar.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Aplicación en todo el territorio nacional, federal y provincial.',
    ],
    examples: [
      'Un contrato que dice "el consumidor renuncia a todos los derechos de la Ley 24.240" es nulo en esa cláusula.',
    ],
    relatedArticles: ['art-24240-3', 'art-24240-37'],
    jurisprudence: [],
    regulations: [],
    keywords: ['orden público', 'irrenunciabilidad', 'territorio nacional'],
    order: 15,
    segments: [
      {
        id: 'seg-24240-65-1',
  ...
  },
  {
    ...
    examples: [
      ...
      'Un importador de herramientas eléctricas sin instrucciones de seguridad en castellano responde por los daños que cause el producto.',
    ],
    relatedArticles: ['art-24240-5', 'art-24240-40'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['cosas riesgosas', 'servicios riesgosos', 'manual', 'seguridad', 'importador'],
    order: 5.5,
    segments: [
      {
        id: 'seg-24240-6-1',
        ...
        practicalExample:
          'Una empresa que vende estufas a gas debe asegurarse de que vengan con las válvulas de seguridad reglamentarias.',
        references: [],
        order: 1,
      },
      {
        ...
        practicalExample:
          'Un importador de taladros industriales sin manual en castellano es responsable ante el usuario lesionado, aunque el fabricante sea alemán.',
        references: [],
        order: 2,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un local que expone ropa con pequeñas fallas de fábrica a precio rebajado debe indicar "con defecto" en forma visible.',
    ],
    relatedArticles: ['art-24240-8', 'art-24240-10'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['cosas deficientes', 'usadas', 'reconstituidas', 'indicación notoria'],
    order: 7.3,
    segments: [
      {
        id: 'seg-24240-9-1',
        ...
        practicalExample:
          'Un supermercado que vende conservas con latas abolladas debe colocar un cartel visible que indique la condición y el motivo del precio rebajado.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un contrato de compra de electrodoméstico en letra microscópica puede ser impugnado por no cumplir el requisito de "fácilmente legible".',
    ],
    relatedArticles: ['art-24240-4', 'art-24240-11'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['documento de venta', 'contrato', 'precio final', 'garantía', 'castellano'],
    order: 7.6,
    segments: [
      {
        id: 'seg-24240-10-1',
        ...
        practicalExample:
          'Al comprar un televisor a crédito, el contrato debe detallar el precio de contado, el precio financiado, el interés y el precio final total.',
        references: [],
        order: 1,
      },
      {
        ...
        practicalExample:
          'Un contrato que dice "ver condiciones en www.empresa.com" sin adjuntarlas en papel o digital incumple la prohibición de reenvíos.',
        references: [],
        order: 2,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El consumidor puede exigir servicio técnico y repuestos durante la vida útil del producto.',
      'Esta obligación es solidaria entre fabricante, importador y vendedor.',
    ],
    examples: [
      'Una importadora de lavarropas debe mantener stock de repuestos y red de técnicos habilitados durante al menos el período de garantía.',
      'Un vendedor que importa un modelo descontinuado sin posibilidad de conseguir repuestos incumple este artículo.',
    ],
    relatedArticles: ['art-24240-11', 'art-24240-13'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['servicio técnico', 'repuestos', 'garantía', 'fabricante', 'importador'],
    order: 8.1,
    segments: [
      {
        id: 'seg-24240-12-1',
        ...
        practicalExample:
          'Una empresa que vende aires acondicionados debe tener técnicos habilitados y disponibilidad de filtros y compresores de repuesto.',
        references: ['art-24240-11'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'El vendedor que repara o reemplaza el producto puede repetir (recobrar) contra el fabricante.',
      'La solidaridad no se puede pactar en contrario frente al consumidor.',
    ],
    examples: [
      'Si un celular importado tiene un defecto de fábrica, el consumidor puede reclamar directamente al local donde lo compró, sin necesidad de contactar al fabricante extranjero.',
    ],
    relatedArticles: ['art-24240-11', 'art-24240-12'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['responsabilidad solidaria', 'garantía', 'productor', 'importador', 'vendedor'],
    order: 8.2,
    segments: [
      {
        id: 'seg-24240-13-1',
        ...
        practicalExample:
          'Al romperse un electrodoméstico dentro de la garantía, el consumidor puede reclamar indistintamente al fabricante, importador, distribuidor o vendedor.',
        references: ['art-24240-11'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Una cláusula que establezca menor garantía es nula de pleno derecho.',
      'El proveedor puede ofrecer garantías mayores pero no menores.',
    ],
    examples: [
      'Un gasista que repara una caldera y cobra el trabajo debe garantizar esa reparación por al menos 30 días.',
      'Una tintorería que devuelve una prenda en mal estado dentro de los 30 días posteriores debe responder sin costo.',
    ],
    relatedArticles: ['art-24240-11', 'art-24240-17'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['garantía servicios', 'treinta días', 'prestación de servicios'],
    order: 8.3,
    segments: [
      {
        id: 'seg-24240-14-1',
        ...
        practicalExample:
          'Un plomero que instala un calefón garantiza su trabajo por 30 días; si se produce una fuga dentro de ese período, debe regresar sin cargo adicional.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Si la reparación fracasa, el prestador no puede cobrar de nuevo: debe sustituir el bien.',
      'La constancia escrita es prueba en caso de reclamo posterior.',
    ],
    examples: [
      'Un servicio técnico que repara un celular debe entregar un formulario detallando qué piezas cambió y qué deficiencia solucionó.',
      'Si el celular vuelve a fallar por el mismo problema dentro de la garantía, el técnico debe reemplazarlo sin costo adicional.',
    ],
    relatedArticles: ['art-24240-14', 'art-24240-17'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['constancia reparación', 'sustitución', 'servicio técnico', 'garantía'],
    order: 8.4,
    segments: [
      {
        id: 'seg-24240-15-1',
        ...
        practicalExample:
          'El servicio técnico de una lavarropas entrega al cliente una orden de trabajo indicando qué componente fue reemplazado.',
        references: [],
        order: 1,
      },
      {
        ...
        practicalExample:
          'Una lavarropas reparada que vuelve a fallar por el mismo motivo dentro de la garantía debe ser reemplazada por una de iguales o superiores características.',
        references: [],
        order: 2,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El proveedor no puede usar los días de reparación para "consumir" el plazo de garantía.',
    ],
    examples: [
      'Una notebook en garantía de 12 meses que pasa 45 días en el service tiene en realidad 12 meses + 45 días de garantía efectiva.',
    ],
    relatedArticles: ['art-24240-11', 'art-24240-15'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['prolongación garantía', 'plazo garantía', 'reparación', 'privación de uso'],
    order: 8.5,
    segments: [
      {
        id: 'seg-24240-16-1',
        ...
        practicalExample:
          'Un televisor en garantía anual que estuvo 30 días en el service tiene garantía hasta 12 meses y 30 días desde la compra.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-15', 'art-24240-16', 'art-24240-40'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['reparación no satisfactoria', 'sustitución', 'devolución', 'quita', 'daños y perjuicios'],
    order: 8.6,
    segments: [
      {
        id: 'seg-24240-17-1',
        ...
        practicalExample:
          'Una impresora reparada que sigue atascando papel: el consumidor puede optar por reemplazo, recuperar lo pagado al precio de hoy, o pagar menos.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['vicios redhibitorios', 'garantía', 'código civil', 'defecto oculto'],
    order: 8.7,
    segments: [
      {
        id: 'seg-24240-18-1',
        ...
        practicalExample:
          'Si la garantía legal de 6 meses venció pero el defecto era oculto al momento de la compra, el consumidor puede iniciar acción por vicios redhibitorios bajo el CCyC.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El incumplimiento de plazos o condiciones ofrecidas habilita al consumidor a rescisión y/o daños.',
      'Aplica a cualquier tipo de servicio: delivery, turismo, salud, tecnología, etc.',
    ],
    examples: [
      'Una empresa de mudanzas que prometió entrega al día siguiente y llegó tres días después incumple este artículo.',
      'Un servicio de streaming que ofreció "sin publicidad" y luego la incorporó viola las condiciones pactadas.',
    ],
    relatedArticles: ['art-24240-7', 'art-24240-8', 'art-24240-20'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['prestación de servicios', 'plazos', 'condiciones', 'publicidad', 'oferta'],
    order: 8.8,
    segments: [
      {
        id: 'seg-24240-19-1',
        ...
        practicalExample:
          'Una empresa de internet que ofrece "instalación en 72 horas" debe respetar ese plazo; si no lo hace, el consumidor puede reclamar por incumplimiento.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un constructor que compra materiales defectuosos para la obra responde por los daños causados aunque el proveedor de materiales también haya fallado.',
    ],
    relatedArticles: ['art-24240-19', 'art-24240-40'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['responsabilidad prestador', 'defectos', 'materiales', 'vicios'],
    order: 8.9,
    segments: [
      {
        id: 'seg-24240-20-1',
        ...
        practicalExample:
          'Un plomero que usa cañerías de mala calidad compradas por él y que luego gotean responde por los daños, sin poder culpar al fabricante de las cañerías.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Un presupuesto sin firma de ambas partes no es válido.',
      'El electricista, plomero o gasista no puede cobrar por hacer el presupuesto en el domicilio del consumidor.',
      'El prestador no puede cobrar más de lo presupuestado sin autorización del consumidor.',
    ],
    examples: [
      'Un electricista que va a revisar una instalación en una casa particular no puede cobrar la visita de presupuesto.',
      'Un service de reparación de celulares que dice "el diagnóstico cuesta $5000" no aplica la gratuidad del presupuesto porque no se realiza en domicilio particular.',
    ],
    relatedArticles: ['art-24240-19', 'art-24240-20'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994'],
    keywords: ['presupuesto', 'reparaciones', 'construcción', 'plomería', 'electricidad', 'gratuito'],
    order: 8.95,
    segments: [
      {
        id: 'seg-24240-21-1',
        ...
        practicalExample:
          'Un mecánico que va a reparar un auto debe presentar presupuesto detallando piezas, mano de obra, plazo de entrega y si la reparación tiene garantía.',
        references: [],
        order: 1,
      },
      {
        ...
        practicalExample:
          'Un gasista que va a inspeccionar la instalación para dar un presupuesto de reparación no puede cobrar esa visita.',
        references: [],
        order: 2,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La oferta masiva (catálogos, ferias, publicidad) activa las protecciones del capítulo.',
    ],
    examples: [
      'Una empresa que ofrece terrenos en cuotas en una feria o por publicidad masiva está alcanzada por este capítulo.',
    ],
    relatedArticles: ['art-24240-7'],
    jurisprudence: [],
    regulations: [],
    keywords: ['ventas fuera del establecimiento', 'inmuebles', 'lotes', 'oferta pública'],
    order: 8.96,
    segments: [
      {
        id: 'seg-24240-22-1',
        ...
        practicalExample:
          'La venta de departamentos en preventa por publicidad en redes sociales está alcanzada por estas protecciones.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Ninguna cláusula contractual puede reducir este plazo o imponer penalidades por ejercerlo.',
      'La notificación puede ser por email, carta documento o devolución física del bien.',
    ],
    examples: [
      'Un consumidor que compra un colchón en una expo y luego lo encuentra más barato puede devolverlo dentro de los 10 días sin costo.',
      'Una empresa que cobra "gastos de cancelación" por ejercer este derecho viola la ley.',
    ],
    relatedArticles: ['art-24240-22', 'art-24240-34'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994', 'Resolución SC 37/2003 (botón de arrepentimiento)'],
    keywords: ['revocación', 'arrepentimiento', 'diez días', 'rescisión', 'botón de arrepentimiento'],
    order: 8.961,
    segments: [
      {
        id: 'seg-24240-23-1',
        ...
        practicalExample:
          'Una persona que compra un televisor en una feria y lo recibe el martes tiene hasta el viernes de la semana siguiente para devolverlo sin penalidades.',
        references: ['art-24240-22'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'El proveedor no puede descontar "gastos de procesamiento" ni retener suma alguna.',
    ],
    examples: [
      'Un consumidor que devuelve una aspiradora dentro de los 10 días debe recibir la totalidad del precio pagado, sin descuentos.',
    ],
    relatedArticles: ['art-24240-23'],
    jurisprudence: [],
    regulations: [],
    keywords: ['efectos revocación', 'reintegro', 'precio', 'devolución inmediata'],
    order: 8.962,
    segments: [
      {
        id: 'seg-24240-24-1',
        ...
        practicalExample:
          'Una empresa de mobiliario debe devolver el anticipo pagado tan pronto el consumidor notifique su arrepentimiento, sin esperar períodos de facturación.',
        references: ['art-24240-23'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'Si una norma específica otorga mejores derechos al consumidor, prevalece esa norma más favorable.',
    ],
    examples: [
      'Una empresa que vende seguros de vida por teléfono debe respetar el derecho de revocación de 10 días del art. 23.',
    ],
    relatedArticles: ['art-24240-22', 'art-24240-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['ventas por correspondencia', 'telecomunicación', 'venta telefónica', 'venta a domicilio'],
    order: 8.963,
    segments: [
      {
        id: 'seg-24240-25-1',
        ...
        practicalExample:
          'Una suscripción a una revista vendida por teléfono puede revocarse dentro de los 10 días sin costo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Establece el principio de simetría: mismas reglas para ambas partes.',
    ],
    examples: [
      'Una empresa de electricidad que cobra 5% de recargo por mora del cliente debe abonar 5% de interés cuando devuelve un cobro indebido.',
    ],
    relatedArticles: ['art-24240-27'],
    jurisprudence: [],
    regulations: [],
    keywords: ['reciprocidad', 'servicios públicos domiciliarios', 'reintegros', 'mora', 'intereses'],
    order: 8.964,
    segments: [
      {
        id: 'seg-24240-26-1',
        ...
        practicalExample:
          'Si una distribuidora de gas cobra 2% mensual por facturas impagas, debe devolver con ese mismo criterio cuando el usuario pagó de más por un error de facturación.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-26'],
    jurisprudence: [],
    regulations: [],
    keywords: ['registro de reclamos', 'servicios públicos', 'constancia', 'número de reclamo'],
    order: 8.965,
    segments: [
      {
        id: 'seg-24240-27-1',
        ...
        practicalExample:
          'La empresa de agua debe aceptar reclamos tanto por correo electrónico como por nota escrita y registrarlos sistemáticamente.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Cobrar un cargo por cancelar el débito automático es ilegal.',
    ],
    examples: [
      'Un usuario que quiere dejar de pagar el gas por débito automático puede hacerlo gratuitamente en cualquier momento.',
    ],
    relatedArticles: ['art-24240-26', 'art-24240-27'],
    jurisprudence: [],
    regulations: [],
    keywords: ['débito automático', 'revocación', 'servicios públicos domiciliarios', 'suministros'],
    order: 8.966,
    segments: [
      {
        id: 'seg-24240-28-1',
        ...
        practicalExample:
          'Un cliente de electricidad que decide pagar manualmente puede cancelar el débito automático sin que la distribuidora le cobre por ese trámite.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La omisión de estos datos es una infracción sancionable.',
    ],
    examples: [
      'La factura de gas natural debe indicar los datos de ENARGAS y el teléfono para reclamos ante ese organismo.',
    ],
    relatedArticles: ['art-24240-27'],
    jurisprudence: [],
    regulations: [],
    keywords: ['factura', 'autoridad de aplicación', 'reclamos', 'servicios públicos'],
    order: 8.967,
    segments: [
      {
        id: 'seg-24240-29-1',
        ...
        practicalExample:
          'La factura de electricidad de Edesur debe incluir los datos del ENRE y su número de teléfono de atención.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-26', 'art-24240-29'],
    jurisprudence: [],
    regulations: [],
    keywords: ['interrupción servicio', 'quita proporcional', 'rescisión', 'deficiencia'],
    order: 8.968,
    segments: [
      {
        id: 'seg-24240-30-1',
        ...
        practicalExample:
          'Un abono de cable que estuvo sin señal durante 3 días puede reclamar el descuento proporcional de esos días en la próxima factura.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La Secretaría tiene facultad para intimar el cese de prácticas anticompetitivas.',
    ],
    examples: [
      'Una empresa de distribución eléctrica que impone cláusulas abusivas aprovechando que el usuario no tiene alternativa puede ser intimada a cesar.',
    ],
    relatedArticles: ['art-24240-26'],
    jurisprudence: [],
    regulations: ['Ley 27.442 de Defensa de la Competencia'],
    keywords: ['posición dominante', 'abuso', 'competencia', 'servicios públicos'],
    order: 8.969,
    segments: [
      {
        id: 'seg-24240-31-1',
        ...
        practicalExample:
          'Una empresa de gas que obliga a los usuarios a contratar también su seguro de instalaciones como condición del servicio comete abuso de posición dominante.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un sorteo que premia al ganador con una suscripción está alcanzado por estas reglas.',
    ],
    relatedArticles: ['art-24240-33', 'art-24240-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['venta domiciliaria', 'catálogo', 'correo', 'distancia', 'fuera del establecimiento'],
    order: 8.97,
    segments: [
      {
        id: 'seg-24240-32-1',
        ...
        practicalExample:
          'La venta de enciclopedias a domicilio o la suscripción ofrecida por teléfono son ventas domiciliarias protegidas por esta ley.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-32', 'art-24240-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['venta por correspondencia', 'e-commerce', 'telecomunicaciones', 'electrónico', 'muestra'],
    order: 8.98,
    segments: [
      {
        id: 'seg-24240-33-1',
        ...
        practicalExample:
          'Una tienda online debe mostrar fotos reales, especificaciones completas y, si es posible, videos del producto antes de que el consumidor confirme la compra.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los cargos automáticos sin consentimiento expreso son ilegales.',
      'Esta protección es clave para combatir suscripciones no solicitadas y renovaciones automáticas no autorizadas.',
    ],
    examples: [
      'Una empresa que envía una tarjeta de crédito no solicitada y cobra un seguro de vida automáticamente viola este artículo.',
      'Una plataforma de streaming que activa una suscripción premium sin el consentimiento expreso del usuario incumple esta norma.',
    ],
    relatedArticles: ['art-24240-32', 'art-24240-33', 'art-24240-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['envíos no solicitados', 'cargo automático', 'débito', 'consentimiento expreso'],
    order: 9.3,
    segments: [
      {
        id: 'seg-24240-35-1',
        ...
        practicalExample:
          'Una empresa de telefonía que agrega un servicio de datos al plan y lo cobra sin que el usuario lo haya pedido viola este artículo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Una tarjeta de crédito que cobra seguros no informados en el contrato viola este artículo.',
    ],
    relatedArticles: ['art-24240-37'],
    jurisprudence: [],
    regulations: ['Decreto 1798/1994', 'Com. BCRA A 5460 (información en créditos al consumo)'],
    keywords: ['crédito al consumo', 'tasa de interés', 'TEA', 'CFT', 'costo financiero total', 'nulidad'],
    order: 9.6,
    segments: [
      {
        id: 'seg-24240-36-1',
        ...
        practicalExample:
          'Al sacar un crédito personal en un banco, el contrato debe mostrar claramente la TEA, el CFT, la cantidad de cuotas y el monto exacto de cada una.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El hecho de que el consumidor haya firmado no convalida las cláusulas abusivas.',
      'Se aplica a contratos de bancos, aseguradoras, telefónicas y cualquier prestador que use formularios.',
    ],
    examples: [
      'El contrato de apertura de cuenta bancaria con cláusula de "jurisdicción exclusiva" del banco puede ser declarado abusivo si perjudica al consumidor.',
    ],
    relatedArticles: ['art-24240-37'],
    jurisprudence: [],
    regulations: [],
    keywords: ['contrato de adhesión', 'formulario', 'cláusulas uniformes', 'control', 'autoridad de aplicación'],
    order: 10.3,
    segments: [
      {
        id: 'seg-24240-38-1',
        ...
        practicalExample:
          'La Secretaría de Comercio puede revisar los términos y condiciones estándar de una empresa de telecomunicaciones y ordenar la eliminación de cláusulas abusivas.',
        references: ['art-24240-37'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-24240-38'],
    jurisprudence: [],
    regulations: [],
    keywords: ['contratos tipo', 'autoridad de aplicación', 'coordinación', 'BCRA', 'ente regulador'],
    order: 10.6,
    segments: [
      {
        id: 'seg-24240-39-1',
        ...
        practicalExample:
          'La Secretaría de Comercio puede solicitar a la SSN que exija la modificación de condiciones abusivas en pólizas de seguros del hogar.',
        references: ['art-24240-38'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-24240-43', 'art-24240-47'],
    jurisprudence: [],
    regulations: [],
    keywords: ['autoridad de aplicación', 'Secretaría de Comercio', 'provincial', 'OMIC', 'jurisdicción'],
    order: 11.1,
    segments: [
      {
        id: 'seg-24240-41-1',
        ...
        practicalExample:
          'En Santa Fe, el organismo local de consumo puede sancionar a un proveedor que incumplió la garantía, sin necesidad de esperar actuación nacional.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-41'],
    jurisprudence: [],
    regulations: [],
    keywords: ['facultades concurrentes', 'interprovincial', 'autoridad de alzada', 'Secretaría de Comercio'],
    order: 11.2,
    segments: [
      {
        id: 'seg-24240-42-1',
        ...
        practicalExample:
          'Un banco nacional que cobra comisiones ilegales a clientes de todo el país puede ser investigado directamente por la autoridad nacional de consumo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['asociaciones de consumidores', 'legitimación', 'acción colectiva', 'interés colectivo'],
    order: 11.3,
    segments: [
      {
        id: 'seg-24240-43-1',
        ...
        practicalExample:
          'Consumidores Libres puede iniciar una demanda contra una empresa de telefonía que cobra cargos no autorizados a miles de clientes.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El registro garantiza la independencia y seriedad de las asociaciones.',
    ],
    examples: [
      'Una "asociación de consumidores" financiada por una empresa de telecomunicaciones no puede representar a usuarios ante esa misma empresa.',
    ],
    relatedArticles: ['art-24240-43'],
    jurisprudence: [],
    regulations: [],
    keywords: ['asociaciones', 'requisitos', 'registro', 'independencia', 'persona jurídica'],
    order: 11.4,
    segments: [
      {
        id: 'seg-24240-44-1',
        ...
        practicalExample:
          'Una asociación de consumidores debe presentar su personería jurídica, acreditar independencia de empresas y estar en el Registro Nacional de Asociaciones de Consumidores.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-41', 'art-24240-47'],
    jurisprudence: [],
    regulations: [],
    keywords: ['procedimiento administrativo', 'denuncia', 'conciliación', 'resolución', 'infracciones'],
    order: 11.5,
    segments: [
      {
        id: 'seg-24240-45-1',
        ...
        practicalExample:
          'Un consumidor que pagó de más por un servicio presenta la denuncia ante la OMIC; se cita a audiencia de conciliación donde la empresa puede ofrecer la devolución y cerrar el caso.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-45', 'art-24240-47'],
    jurisprudence: [],
    regulations: [],
    keywords: ['incumplimiento', 'acuerdo conciliatorio', 'sanción', 'infracción', 'conciliación'],
    order: 11.6,
    segments: [
      {
        id: 'seg-24240-46-1',
        ...
        practicalExample:
          'Si en una audiencia de conciliación la empresa acuerda cambiar el producto defectuoso y no lo hace en el plazo pactado, el organismo puede mullarla directamente.',
        references: ['art-24240-47'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['denuncia maliciosa', 'mala fe', 'sanción', 'daños y perjuicios'],
    order: 12.1,
    segments: [
      {
        id: 'seg-24240-48-1',
        ...
        practicalExample:
          'Un consumidor que denuncia a un comercio inventando que le vendieron un producto vencido, siendo eso falso, puede ser multado y obligado a indemnizar al comerciante.',
        references: ['art-24240-47'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-47'],
    jurisprudence: [],
    regulations: [],
    keywords: ['graduación sanciones', 'reincidencia', 'multa', 'agravantes', 'tres años'],
    order: 12.2,
    segments: [
      {
        id: 'seg-24240-49-1',
        ...
        practicalExample:
          'Una empresa de seguros que deliberadamente retrasa liquidaciones para reducir pagos recibe una multa agravada por la intencionalidad.',
        references: ['art-24240-47'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['prescripción', 'tres años', 'interrupción', 'acciones judiciales'],
    order: 12.3,
    segments: [
      {
        id: 'seg-24240-50-1',
        ...
        practicalExample:
          'Un consumidor que fue víctima de publicidad engañosa en enero de 2022 tiene hasta enero de 2025 para reclamar, o más si otra ley le da mayor plazo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-52'],
    jurisprudence: [],
    regulations: [],
    keywords: ['daños y perjuicios', 'resarcimiento', 'acción judicial', 'damnificado'],
    order: 12.4,
    segments: [
      {
        id: 'seg-24240-51-1',
        ...
        practicalExample:
          'Una empresa multada por la OMIC por garantía incumplida sigue estando obligada a indemnizar al consumidor perjudicado por los daños que le causó.',
        references: ['art-24240-52'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-24240-51', 'art-24240-52'],
    jurisprudence: [],
    regulations: [],
    keywords: ['proceso judicial', 'carga de la prueba', 'costas', 'prueba dinámica', 'multa judicial'],
    order: 14.1,
    segments: [
      {
        id: 'seg-24240-53-1',
        ...
        practicalExample:
          'Al reclamar por una garantía incumplida, el proveedor debe probar que cumplió, no el consumidor. Si el consumidor pierde igualmente, no paga las costas del proveedor.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-43', 'art-24240-53'],
    jurisprudence: [],
    regulations: [],
    keywords: ['acciones colectivas', 'acuerdo conciliatorio', 'publicidad', 'homologación', 'juicio colectivo'],
    order: 14.2,
    segments: [
      {
        id: 'seg-24240-54-1',
        ...
        practicalExample:
          'Un acuerdo entre una empresa de cable y una asociación de consumidores en un juicio colectivo debe publicarse en diarios nacionales para que todos los abonados afectados puedan conocerlo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-43', 'art-24240-54'],
    jurisprudence: [],
    regulations: [],
    keywords: ['legitimación activa', 'Defensor del Pueblo', 'acción colectiva', 'asociaciones de consumidores'],
    order: 14.3,
    segments: [
      {
        id: 'seg-24240-55-1',
        ...
        practicalExample:
          'El Defensor del Pueblo de la Nación puede iniciar una acción colectiva contra una empresa de transporte que incumple sistemáticamente los horarios y no indemniza a los pasajeros.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Registro es la herramienta de control de la seriedad e independencia de las asociaciones.',
    ],
    examples: [
      'Una nueva asociación de consumidores que quiera representar a usuarios en juicios colectivos debe inscribirse primero en el Registro Nacional.',
    ],
    relatedArticles: ['art-24240-44'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Registro Nacional', 'asociaciones de consumidores', 'inscripción'],
    order: 14.4,
    segments: [
      {
        id: 'seg-24240-56-1',
        ...
        practicalExample:
          'Consumidores Libres y la Unión de Consumidores Argentina están inscriptas en este Registro y por eso pueden iniciar acciones judiciales colectivas.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La falta de presentación de memorias puede significar la cancelación del registro.',
      'La autoridad puede pedir información en cualquier momento para verificar el cumplimiento.',
    ],
    examples: [
      'Una asociación de consumidores debe presentar anualmente un informe detallando cuántos reclamos tramitó, cuántas acciones judiciales inició y cuánto dinero recuperó para sus socios.',
    ],
    relatedArticles: ['art-24240-56'],
    jurisprudence: [],
    regulations: [],
    keywords: ['obligaciones asociaciones', 'contabilidad', 'memoria anual', 'transparencia'],
    order: 14.5,
    segments: [
      {
        id: 'seg-24240-57-1',
        ...
        practicalExample:
          'Una asociación de consumidores que no presenta la memoria anual durante dos años consecutivos puede ser suspendida del Registro.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-43', 'art-24240-56'],
    jurisprudence: [],
    regulations: [],
    keywords: ['transformación', 'personería', 'independencia', 'cooperativas', 'sindicatos'],
    order: 14.6,
    segments: [
      {
        id: 'seg-24240-58-1',
        ...
        practicalExample:
          'El sindicato de empleados bancarios puede fundar una asociación de consumidores de servicios financieros, pero debe ser una persona jurídica completamente separada.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los consumidores pueden participar en la integración del tribunal arbitral.',
      'El COPREC (sistema de conciliación previa) es un desarrollo de este artículo.',
    ],
    examples: [
      'En Buenos Aires existe el SACT (Sistema de Arbitraje de Consumo) que permite resolver conflictos sin ir a la justicia ordinaria.',
    ],
    relatedArticles: ['art-24240-45', 'art-24240-53'],
    jurisprudence: [],
    regulations: ['Decreto 276/1998 (Sistema Nacional de Arbitraje de Consumo)'],
    keywords: ['arbitraje', 'tribunal arbitral', 'conciliación', 'COPREC', 'resolución alternativa'],
    order: 14.7,
    segments: [
      {
        id: 'seg-24240-59-1',
        ...
        practicalExample:
          'Un consumidor con un reclamo de $50,000 por garantía incumplida puede optar por el sistema de arbitraje de consumo local en lugar de iniciar un juicio ordinario.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-61'],
    jurisprudence: [],
    regulations: [],
    keywords: ['educación al consumidor', 'formación', 'Estado', 'escuelas', 'campaña'],
    order: 14.8,
    segments: [
      {
        id: 'seg-24240-60-1',
        ...
        practicalExample:
          'Una municipalidad que dicta talleres gratuitos sobre derechos del consumidor en los centros de salud cumple con la obligación de este artículo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Conocer los "mecanismos de defensa" (dónde y cómo reclamar) es parte del derecho a la educación del consumidor.',
    ],
    examples: [
      'Una guía escolar que explica cómo comparar precios, leer etiquetas de alimentos y dónde reclamar si un producto es peligroso cumple con este artículo.',
    ],
    relatedArticles: ['art-24240-60'],
    jurisprudence: [],
    regulations: [],
    keywords: ['formación consumidor', 'educación', 'salud', 'seguridad', 'precios', 'calidad'],
    order: 14.9,
    segments: [
      {
        id: 'seg-24240-61-1',
        ...
        practicalExample:
          'Un programa municipal de consumo responsable que enseña a comparar precios, identificar sellos de calidad y acceder al SACT cumple con los objetivos de este artículo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-24240-60', 'art-24240-61'],
    jurisprudence: [],
    regulations: [],
    keywords: ['educación', 'planes de enseñanza', 'currículo', 'Ministerio de Educación'],
    order: 14.91,
    segments: [
      {
        id: 'seg-24240-62-1',
        ...
        practicalExample:
          'Una escuela secundaria que incluye una unidad sobre "derechos del consumidor y cómo reclamar" en la materia de Economía cumple con este mandato.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Protege al consumidor de presiones comerciales durante el período de arrepentimiento.',
    ],
    examples: [
      'Un vendedor a domicilio no puede exigir judicialmente el pago del bien durante los 10 días de arrepentimiento del consumidor.',
    ],
    relatedArticles: ['art-24240-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['revocación', 'ejecutiva', 'contrato fuera del establecimiento', 'plazo'],
    order: 14.92,
    segments: [
      {
        id: 'seg-24240-63-1',
        ...
        practicalExample:
          'Un vendedor de enciclopedias a domicilio no puede iniciar acciones judiciales por falta de pago mientras los 10 días de arrepentimiento del consumidor no hayan transcurrido.',
        references: ['art-24240-34'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'Es una sanción adicional a la indemnización por daños y perjuicios.',
      'Aplica tanto por incumplimiento contractual como por incumplimiento de obligaciones legales.',
    ],
    examples: [
      'Una empresa que no entrega un producto en el plazo prometido debe pagar multa al consumidor, además de devolver el precio o entregar el bien.',
    ],
    relatedArticles: ['art-24240-47', 'art-24240-51'],
    jurisprudence: [],
    regulations: [],
    keywords: ['cláusula penal', 'multa al consumidor', 'incumplimiento', 'sanción'],
    order: 14.93,
    segments: [
      {
        id: 'seg-24240-64-1',
        ...
        practicalExample:
          'Un banco que cobra comisiones no autorizadas a miles de clientes debe pagar multa a cada cliente afectado más los daños causados.',
        references: ['art-24240-47'],
        order: 1,
      },
    ],
