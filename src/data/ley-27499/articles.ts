...
export const ARTICLES_27499: Article[] = [
  {
    id: 'art-27499-1',
    lawId: 'ley-27499',
    number: '1',
    ...
    examples: [
      ...
      'El personal contratado temporalmente en organismos del Estado también queda comprendido',
    ],
    relatedArticles: ['art-27499-3', 'art-27499-4', 'art-27499-8'],
    jurisprudence: [],
    regulations: ['Decreto 473/2019 (reglamentario)'],
    keywords: ['capacitación obligatoria', 'género', 'violencia contra la mujer', 'función pública', 'tres poderes'],
    order: 1,
    segments: [
      {
        id: 'seg-27499-1-0',
        ...
        practicalExample:
          'El presidente de la Corte Suprema y el portero del Ministerio de Trabajo tienen la misma obligación de capacitarse en género.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-27499-1', 'art-27499-4', 'art-27499-5'],
    jurisprudence: [],
    regulations: [],
    keywords: ['modalidad', 'implementación', 'organismos'],
    order: 2,
    segments: [
      {
        id: 'seg-27499-2-0',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Tiene poder para observar y solicitar modificaciones a los programas que no cumplan los estándares',
      'Centraliza la información sobre el grado de cumplimiento de cada organismo',
    ],
    examples: [
      'Si un ministerio diseña una capacitación que el INAM considera insuficiente, puede exigir modificaciones antes de certificarla',
    ],
    relatedArticles: ['art-27499-5', 'art-27499-6', 'art-27499-7'],
    jurisprudence: [],
    regulations: [],
    keywords: ['INAM', 'Instituto Nacional de las Mujeres', 'autoridad de aplicación'],
    order: 3,
    segments: [
      {
        id: 'seg-27499-3-0',
  ...
  },
  {
    ...
    examples: [
      ...
      'El Ministerio de Seguridad puede adaptar el material del INAM para las fuerzas policiales o crear uno específico para el contexto de seguridad',
    ],
    relatedArticles: ['art-27499-1', 'art-27499-5'],
    jurisprudence: [],
    regulations: [],
    keywords: ['máximas autoridades', 'responsabilidad', 'implementación', 'plazo', 'sindicatos'],
    order: 4,
    segments: [
      {
        id: 'seg-27499-4-0',
        ...
        practicalExample:
          'El Ministro de Justicia debe asegurarse de que todos sus empleados —incluyendo los del servicio penitenciario— reciban capacitación en género.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-27499-3', 'art-27499-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['certificación', 'calidad', 'INAM', 'programas de capacitación'],
    order: 5,
    segments: [
      {
        id: 'seg-27499-5-0',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las altas autoridades no pueden "delegar" su capacitación o usar el programa general de su organismo',
    ],
    examples: [
      'El presidente de la Corte Suprema debe recibir la capacitación que el INAM dicte específicamente para las autoridades del Poder Judicial, no el programa general de la institución',
    ],
    relatedArticles: ['art-27499-3', 'art-27499-7'],
    jurisprudence: [],
    regulations: [],
    keywords: ['altas autoridades', 'INAM', 'máximas autoridades', 'Corte Suprema', 'ministros'],
    order: 6,
    segments: [
      {
        id: 'seg-27499-6-0',
        ...
        practicalExample:
          'El presidente y los ministros del gabinete participan en capacitaciones diseñadas y dictadas por el INAM, no por el área de recursos humanos de cada ministerio.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un periodista puede consultar la web del INAM y reportar qué porcentaje del Poder Judicial completó la capacitación en género',
    ],
    relatedArticles: ['art-27499-3', 'art-27499-8'],
    jurisprudence: [],
    regulations: [],
    keywords: ['transparencia', 'publicidad', 'informe anual', 'web INAM', 'Micaela García'],
    order: 7,
    segments: [
      {
        id: 'seg-27499-7-0',
        ...
        practicalExample:
          'Cualquier persona puede entrar a la web del INAM y ver que el Ministerio X tiene solo el 40% de su personal capacitado.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-27499-1', 'art-27499-7'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sanción', 'falta grave', 'incumplimiento', 'intimación', 'disciplinaria'],
    order: 8,
    segments: [
      {
        id: 'seg-27499-8-0',
        ...
        practicalExample:
          'Un empleado del PAMI que recibe tres invitaciones a la capacitación y no asiste es intimado formalmente; si sigue sin ir, incurre en falta grave.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['financiamiento', 'presupuesto', 'partidas presupuestarias'],
    order: 9,
    segments: [
      {
        id: 'seg-27499-9-0',
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['adhesión', 'provincias', 'CABA', 'competencia legislativa'],
    order: 10,
    segments: [
      {
        id: 'seg-27499-10-0',
        ...
        practicalExample:
          'Sin adhesión provincial, un empleado del gobierno de Mendoza no está alcanzado por la Ley Micaela nacional, pero sí por la ley provincial si Mendoza adhirió.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-27499-4', 'art-27499-5'],
    jurisprudence: [],
    regulations: [],
    keywords: ['cláusula transitoria', 'programas INAM', 'implementación inmediata'],
    order: 12,
    segments: [
      {
        id: 'seg-27499-ct-0',
