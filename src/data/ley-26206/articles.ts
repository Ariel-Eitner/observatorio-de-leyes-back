...
export const ARTICLES_26206: Article[] = [
  {
    id: 'art-26206-1',
    lawId: 'ley-26206',
    number: '1',
    ...
    practicalEffects: [
      ...
      'Vincula la educación con los tratados de derechos humanos internacionales.',
    ],
    examples: [],
    relatedArticles: ['art-26206-2', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derecho a la educación', 'enseñar y aprender', 'Constitución Nacional'],
    order: 1,
    segments: [
      {
        id: 'seg-26206-1-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-1', 'art-26206-4', 'art-26206-9'],
    jurisprudence: [],
    regulations: [],
    keywords: ['bien público', 'derecho a la educación', 'gratuidad', 'Estado'],
    order: 2,
    segments: [
      {
        id: 'seg-26206-2-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-2', 'art-26206-9', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['responsabilidad del Estado', 'gratuidad', 'igualdad', 'equidad', 'educación integral'],
    order: 3,
    segments: [
      {
        id: 'seg-26206-4-1',
        ...
        practicalExample:
          'Una provincia no puede cobrar aranceles en escuelas públicas secundarias: la gratuidad es garantía constitucional y legal.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Estado Nacional puede intervenir cuando una provincia no cumple los estándares mínimos.',
      'El Consejo Federal de Educación es el ámbito donde Nación y provincias coordinan la política educativa.',
    ],
    examples: [
      'El Ministerio de Educación fija un diseño curricular base para el nivel secundario; cada provincia lo adapta con un porcentaje de contenidos propios.',
    ],
    relatedArticles: ['art-26206-4', 'art-26206-6'],
    jurisprudence: [],
    regulations: [],
    keywords: ['política educativa', 'unidad nacional', 'particularidades provinciales', 'federalismo educativo'],
    order: 3.2,
    segments: [
      {
        id: 'seg-26206-5-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-4', 'art-26206-5', 'art-26206-9'],
    jurisprudence: [],
    regulations: [],
    keywords: ['responsabilidades del Estado', 'derecho a la educación', 'acceso', 'financiamiento', 'gratuidad'],
    order: 3.4,
    segments: [
      {
        id: 'seg-26206-6-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El acceso a la información pública está vinculado a este derecho.',
      'El Estado no puede cobrar por el acceso a contenidos educativos básicos.',
    ],
    examples: [
      'El programa Conectar Igualdad (entrega de netbooks a alumnos secundarios) fue una política de implementación de este artículo.',
    ],
    relatedArticles: ['art-26206-2', 'art-26206-6'],
    jurisprudence: [],
    regulations: [],
    keywords: ['información', 'conocimiento', 'participación democrática', 'justicia social', 'acceso universal'],
    order: 3.6,
    segments: [
      {
        id: 'seg-26206-7-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La educación en valores no es opcional: es un mandato legal.',
      'La formación "a lo largo de toda la vida" incluye los programas de educación de adultos y la formación profesional.',
    ],
    examples: [
      'Los programas de educación para adultos que permiten terminar el secundario a personas de 40 años responden a este mandato de educación a lo largo de toda la vida.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-2'],
    jurisprudence: [],
    regulations: [],
    keywords: ['formación integral', 'proyecto de vida', 'valores', 'educación permanente', 'solidaridad'],
    order: 3.8,
    segments: [
      {
        id: 'seg-26206-8-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-4', 'art-26206-2'],
    jurisprudence: [],
    regulations: ['Ley 26.075 (metas de financiamiento educativo)'],
    keywords: ['financiamiento', '6% PBI', 'presupuesto educativo', 'inversión educativa'],
    order: 4,
    segments: [
      {
        id: 'seg-26206-9-1',
        ...
        practicalExample:
          'Un presupuesto nacional que destine solo el 4,5% del PBI a educación viola esta norma, independientemente de las razones de ajuste fiscal.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las cooperativas escolares y las escuelas de gestión social tienen reconocimiento legal.',
      'El Estado supervisa la calidad tanto en escuelas públicas como privadas.',
    ],
    examples: [
      'Una escuela privada de la ciudad de Buenos Aires es parte del Sistema Educativo Nacional y está obligada a enseñar los contenidos curriculares comunes, incluyendo la ESI.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sistema educativo', 'gestión estatal', 'gestión privada', 'cooperativa', 'integración'],
    order: 4.5,
    segments: [
      {
        id: 'seg-26206-10-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Incluye expresamente la educación sexual integral (ESI) y el respeto a la diversidad.',
      'La discriminación de género en el ámbito educativo viola este artículo.',
    ],
    examples: [
      'Una escuela que no adapta su propuesta para alumnos con discapacidad viola el objetivo (n) de este artículo.',
      'Un establecimiento que impone uniformes diferenciados por género que estigmatizan a estudiantes trans viola el objetivo (f).',
    ],
    relatedArticles: ['art-26206-2', 'art-26206-16'],
    jurisprudence: [],
    regulations: [],
    keywords: ['fines educativos', 'inclusión', 'igualdad', 'ESI', 'educación sexual', 'pueblos indígenas', 'discapacidad'],
    order: 5,
    segments: [
      {
        id: 'seg-26206-11-1',
        ...
        practicalExample:
          'Los programas de becas, comedor escolar, transporte escolar y apoyo pedagógico son expresiones de este objetivo de inclusión.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los alumnos tienen derecho a participar en los centros de estudiantes y a expresar sus opiniones.',
      'Las escuelas no pueden censurar las expresiones de los alumnos en sus publicaciones estudiantiles.',
    ],
    examples: [
      'Un alumno que es víctima de bullying por parte de docentes puede invocar este artículo para exigir protección.',
      'Los centros de estudiantes son una forma de ejercicio del derecho de participación en la vida institucional.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-13'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derechos de alumnos', 'dignidad', 'participación', 'expresión', 'bullying', 'orientación vocacional'],
    order: 5.2,
    segments: [
      {
        id: 'seg-26206-12-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-12', 'art-26206-14'],
    jurisprudence: [],
    regulations: ['Ley 25.919 (garantía salarial docente)'],
    keywords: ['derechos docentes', 'libertad de cátedra', 'salario', 'participación', 'formación continua'],
    order: 5.4,
    segments: [
      {
        id: 'seg-26206-13-1',
  ...
  },
  {
    ...
    examples: [
      ...
      'Si un alumno de 12 años falta reiteradamente sin justificación, el establecimiento puede notificar a las autoridades de protección de derechos.',
    ],
    relatedArticles: ['art-26206-12', 'art-26206-16'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derechos padres', 'obligaciones padres', 'información escolar', 'participación', 'obligatoriedad'],
    order: 5.6,
    segments: [
      {
        id: 'seg-26206-14-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La estructura de 4 niveles (inicial, primario, secundario, superior) es la misma en todas las provincias.',
      'La articulación permite que un estudiante pase de primario a secundario sin procedimientos complejos.',
    ],
    examples: [
      'Un alumno que termina la primaria en Neuquén puede continuar el secundario en Santa Fe sin necesidad de revalidar sus estudios.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-5'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sistema educativo', 'unidad', 'articulación', 'cohesión', 'movilidad educativa'],
    order: 5.8,
    segments: [
      {
        id: 'seg-26206-15-1',
  ...
  },
  {
    ...
    examples: [
      ...
      'Las escuelas de adultos o con modalidades flexibles son una forma de garantizar la obligatoriedad en contextos especiales.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['obligatoriedad escolar', 'educación secundaria', '5 años', 'escolaridad obligatoria'],
    order: 6,
    segments: [
      {
        id: 'seg-26206-16-1',
        ...
        practicalExample:
          'Un padre que retira a su hijo de 14 años del colegio para que trabaje incumple la obligatoriedad escolar y puede ser intimado por las autoridades educativas.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La educación en cárceles, hospitales y zonas rurales tiene reconocimiento legal.',
    ],
    examples: [
      'Un preso tiene derecho a recibir educación formal dentro del penal (Educación en Contextos de Privación de Libertad).',
      'Un niño hospitalizado tiene derecho a continuar su educación en el hospital (Educación Domiciliaria y Hospitalaria).',
    ],
    relatedArticles: ['art-26206-16'],
    jurisprudence: [],
    regulations: [],
    keywords: ['estructura educativa', 'niveles', 'modalidades', 'educación especial', 'intercultural bilingüe', 'educación en cárceles'],
    order: 7,
    segments: [
      {
        id: 'seg-26206-17-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-16'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Inicial', 'sala de 5 años', 'jardín maternal', 'obligatoriedad', '45 días'],
    order: 7.1,
    segments: [
      {
        id: 'seg-26206-18-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-18', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos Educación Inicial', 'juego', 'sujetos de derechos', 'desarrollo integral', 'primera infancia'],
    order: 7.15,
    segments: [
      {
        id: 'seg-26206-19-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-18', 'art-26206-19'],
    jurisprudence: [],
    regulations: [],
    keywords: ['universalización', 'sala de 4 años', 'sala de 3 años', 'cobertura', 'Educación Inicial'],
    order: 7.2,
    segments: [
      {
        id: 'seg-26206-20-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-22'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Primaria', 'obligatoria', '6 años', 'EGB', 'estructura educativa'],
    order: 7.25,
    segments: [
      {
        id: 'seg-26206-21-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El desarrollo integral incluye educación física, artes, música y formación ciudadana.',
      'Los saberes comunes garantizan que todos los egresados de primaria tengan la misma base mínima.',
    ],
    examples: [
      'Una escuela primaria que no tiene computadoras o acceso a internet no está cumpliendo con el objetivo de formación en nuevas tecnologías.',
    ],
    relatedArticles: ['art-26206-21', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos primaria', 'saberes comunes', 'desarrollo integral', 'tecnología', 'trabajo en equipo'],
    order: 7.3,
    segments: [
      {
        id: 'seg-26206-22-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas secundarias no pueden expulsar definitivamente a alumnos sin ofrecer alternativas.',
      'Deben existir modalidades flexibles (nocturnas, semipresenciales, FinEs) para quienes no pueden asistir en horario regular.',
    ],
    examples: [
      'Un adolescente de 18 años que trabaja tiene derecho a terminar el secundario y el Estado debe ofrecerle una modalidad adecuada (como el Plan FinEs o la educación nocturna).',
    ],
    relatedArticles: ['art-26206-16', 'art-26206-24'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Secundaria', 'obligatoria', 'adolescentes', 'jóvenes'],
    order: 7.35,
    segments: [
      {
        id: 'seg-26206-23-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El ciclo orientado es donde aparecen las especialidades: bachiller en ciencias naturales, en economía, en arte, etc.',
      'Los alumnos que cambian de escuela entre el ciclo básico y el orientado no pierden años.',
    ],
    examples: [
      'Un estudiante hace el ciclo básico (1er y 2do año) en una escuela y el orientado en otra de la misma modalidad, sin perder materias.',
    ],
    relatedArticles: ['art-26206-23', 'art-26206-25'],
    jurisprudence: [],
    regulations: [],
    keywords: ['ciclos', 'ciclo básico', 'ciclo orientado', 'orientaciones', 'Educación Secundaria'],
    order: 7.4,
    segments: [
      {
        id: 'seg-26206-24-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas técnicas responden al objetivo de formación para el mundo del trabajo.',
      'La formación ciudadana y ética debe estar integrada en todos los curricula secundarios.',
    ],
    examples: [
      'Un colegio secundario que tiene un departamento de orientación vocacional con psicólogos cumple el objetivo (e) de este artículo.',
    ],
    relatedArticles: ['art-26206-24', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos secundaria', 'formación ética', 'ciudadanía', 'mundo del trabajo', 'orientación vocacional'],
    order: 7.45,
    segments: [
      {
        id: 'seg-26206-25-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-15', 'art-26206-24'],
    jurisprudence: [],
    regulations: [],
    keywords: ['pase de nivel', 'equivalencias', 'movilidad educativa', 'provincias', 'acreditación'],
    order: 7.5,
    segments: [
      {
        id: 'seg-26206-26-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-28'],
    jurisprudence: [],
    regulations: ['Ley 24.521 (Educación Superior)'],
    keywords: ['Educación Superior', 'universidades', 'institutos superiores', 'formación docente', 'terciario'],
    order: 7.55,
    segments: [
      {
        id: 'seg-26206-27-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los institutos de formación docente son clave para garantizar la calidad de todos los niveles.',
      'La articulación con el sistema productivo justifica las universidades regionales y los tecnicaturas orientados a sectores específicos.',
    ],
    examples: [
      'Una universidad provincial que abre una tecnicatura en viticultura en respuesta a las necesidades de la industria local cumple el objetivo de articulación con el sistema productivo.',
    ],
    relatedArticles: ['art-26206-27', 'art-26206-29'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación superior', 'investigación', 'formación docente', 'ciudadanía', 'sistema productivo'],
    order: 7.6,
    segments: [
      {
        id: 'seg-26206-28-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los ciclos iniciales universitarios (CBC en UBA, por ejemplo) son expresiones de articulación.',
      'Los institutos terciarios pueden tener convenios con universidades para el reconocimiento de materias.',
    ],
    examples: [
      'El CBC de la UBA o el Ingreso universitario de la UNLP son mecanismos de articulación entre el secundario y el nivel universitario.',
    ],
    relatedArticles: ['art-26206-27', 'art-26206-28'],
    jurisprudence: [],
    regulations: [],
    keywords: ['articulación', 'secundario-superior', 'continuidad de estudios', 'ingreso universitario'],
    order: 7.65,
    segments: [
      {
        id: 'seg-26206-29-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los institutos técnicos superiores (IES técnicos) forman técnicos superiores en áreas específicas.',
      'El título de técnico habilita para el ejercicio de la profesión sin necesidad de un título universitario.',
    ],
    examples: [
      'Un egresado de una escuela técnica con orientación electrónica puede trabajar como técnico electrónico con su título habilitante, sin necesidad de ir a la universidad.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-27'],
    jurisprudence: [],
    regulations: ['Ley 26.058 (Educación Técnico Profesional)'],
    keywords: ['educación técnica', 'técnico medio', 'técnico superior', 'habilitación profesional', 'Ley 26058'],
    order: 7.7,
    segments: [
      {
        id: 'seg-26206-30-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-32'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Artística', 'lenguajes artísticos', 'bachiller artístico', 'música', 'plástica'],
    order: 7.71,
    segments: [
      {
        id: 'seg-26206-31-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La producción artística argentina debe tener presencia específica en los contenidos.',
      'Los talleres de música, teatro, danza y artes visuales son expresión de estos objetivos.',
    ],
    examples: [
      'Una clase de música que enseña a los alumnos a tocar instrumentos y crear sus propias composiciones cumple mejor los objetivos que una que solo enseña historia de la música.',
    ],
    relatedArticles: ['art-26206-31', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación artística', 'expresividad', 'creadores de cultura', 'arte nacional'],
    order: 7.72,
    segments: [
      {
        id: 'seg-26206-32-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-34'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Especial', 'discapacidad', 'inclusión educativa', 'maestra integradora', 'adaptación curricular'],
    order: 7.73,
    segments: [
      {
        id: 'seg-26206-33-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las propuestas pedagógicas deben ser individualizadas según las necesidades de cada alumno.',
      'El objetivo es el máximo desarrollo: no hay un techo predefinido para el alumno con discapacidad.',
    ],
    examples: [
      'Una escuela especial diseña un proyecto de integración con una escuela primaria común, donde alumnos de ambas instituciones comparten actividades recreativas y algunas materias.',
    ],
    relatedArticles: ['art-26206-33', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación especial', 'inclusión', 'integración', 'propuesta pedagógica individual', 'discapacidad'],
    order: 7.74,
    segments: [
      {
        id: 'seg-26206-34-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-36'],
    jurisprudence: [],
    regulations: [],
    keywords: ['EPJA', 'educación de adultos', 'FinEs', 'CENS', 'alfabetización', 'educación a lo largo de la vida'],
    order: 7.75,
    segments: [
      {
        id: 'seg-26206-35-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los egresados pueden seguir estudiando en el nivel superior (terciario o universitario).',
      'Los curricula de adultos deben respetar sus saberes previos y experiencias de vida.',
    ],
    examples: [
      'Un adulto que completa el secundario nocturno puede inscribirse en una tecnicatura superior sin restricciones.',
    ],
    relatedArticles: ['art-26206-35', 'art-26206-8'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos EPJA', 'formación básica', 'empleo', 'participación ciudadana', 'terminalidad'],
    order: 7.76,
    segments: [
      {
        id: 'seg-26206-36-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-38'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Rural', 'plurigrado', 'alternancia', 'zonas rurales', 'escuela rural'],
    order: 7.77,
    segments: [
      {
        id: 'seg-26206-37-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas rurales pueden integrar proyectos productivos (huertas, pequeñas cooperativas) como contenido pedagógico.',
      'El objetivo de mantener el vínculo comunitario apunta a evitar que la educación genere éxodo rural.',
    ],
    examples: [
      'Una escuela rural primaria incluye una huerta orgánica como proyecto pedagógico integrado al curriculum de ciencias naturales y matemática.',
    ],
    relatedArticles: ['art-26206-37', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación rural', 'saberes comunes', 'vínculo comunitario', 'cooperativismo', 'adaptación curricular'],
    order: 7.78,
    segments: [
      {
        id: 'seg-26206-38-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-17', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['EIB', 'pueblos indígenas', 'interculturalidad', 'bilingüismo', 'cosmovisión', 'art. 75 inc. 17 CN'],
    order: 7.79,
    segments: [
      {
        id: 'seg-26206-39-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La historia de los pueblos indígenas debe enseñarse desde la perspectiva del propio pueblo, no solo desde la historia oficial.',
      'Los auxiliares docentes comunitarios (ADC) son parte de la EIB: son miembros de la comunidad que apoyan la enseñanza en lengua indígena.',
    ],
    examples: [
      'Una escuela de la EIB diseña su currículo con la participación de ancianos y referentes de la comunidad, incorporando conocimientos sobre plantas medicinales, astronomía ancestral y relatos orales como contenidos académicos.',
    ],
    relatedArticles: ['art-26206-39', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos EIB', 'lengua indígena', 'currículo propio', 'historia indígena', 'auxiliares docentes comunitarios'],
    order: 7.80,
    segments: [
      {
        id: 'seg-26206-40-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Programa UBA XXII permite a presos cursar materias universitarias dentro de las cárceles.',
      'Los directivos penitenciarios no pueden negar el acceso a la educación como medida disciplinaria.',
    ],
    examples: [
      'Un interno se inscribe en el FinEs en el pabellón educativo de la cárcel y termina el secundario mientras cumple su condena.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-42'],
    jurisprudence: [],
    regulations: [],
    keywords: ['educación en cárceles', 'privación de libertad', 'reinserción', 'derecho a educación'],
    order: 7.81,
    segments: [
      {
        id: 'seg-26206-41-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los talleres culturales y recreativos son parte del sistema educativo en contexto de encierro.',
    ],
    examples: [
      'Un taller de cerámica dentro de una unidad penal es parte del sistema educativo (educación no formal) bajo este artículo.',
    ],
    relatedArticles: ['art-26206-41'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación en cárceles', 'reinserción social', 'escolaridad obligatoria', 'formación técnica'],
    order: 7.82,
    segments: [
      {
        id: 'seg-26206-42-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los hospitales con internaciones prolongadas deben tener aulas hospitalarias.',
    ],
    examples: [
      'Un niño con leucemia que pasa 6 meses en tratamiento hospitalario tiene un maestro que va a su habitación.',
    ],
    relatedArticles: ['art-26206-17', 'art-26206-44'],
    jurisprudence: [],
    regulations: [],
    keywords: ['Educación Domiciliaria', 'Educación Hospitalaria', 'salud', 'aula hospitalaria', 'maestro domiciliario'],
    order: 7.83,
    segments: [
      {
        id: 'seg-26206-43-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Al recuperarse, el alumno vuelve a su escuela sin haber perdido el hilo de los contenidos.',
    ],
    examples: [
      'Una alumna que pasó 3 meses en reposo es acompañada por un maestro domiciliario: cuando regresa, no está atrasada.',
    ],
    relatedArticles: ['art-26206-43'],
    jurisprudence: [],
    regulations: [],
    keywords: ['objetivos educación domiciliaria', 'continuidad de estudios', 'revinculación'],
    order: 7.84,
    segments: [
      {
        id: 'seg-26206-44-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El CFE aprueba los NAP que rigen el currículo en todo el país.',
    ],
    examples: [
      'El CFE aprueba los NAP de Matemática para el nivel primario; todas las provincias los incorporan a sus diseños curriculares.',
    ],
    relatedArticles: ['art-26206-5', 'art-26206-46'],
    jurisprudence: [],
    regulations: [],
    keywords: ['CFE', 'Consejo Federal de Educación', 'NAP', 'coordinación interjurisdiccional'],
    order: 7.85,
    segments: [
      {
        id: 'seg-26206-45-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los criterios de acreditación del nivel secundario deben ser equivalentes en todas las provincias.',
    ],
    examples: [
      'El CFE acuerda que el bachiller tenga equivalencias en todo el país, facilitando el acceso a las universidades sin trámites adicionales.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-92'],
    jurisprudence: [],
    regulations: [],
    keywords: ['funciones CFE', 'NAP', 'contenidos curriculares', 'reconocimiento de títulos'],
    order: 7.86,
    segments: [
      {
        id: 'seg-26206-46-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-48', 'art-26206-27'],
    jurisprudence: [],
    regulations: [],
    keywords: ['INFD', 'formación docente', 'validez nacional', 'institutos terciarios'],
    order: 7.87,
    segments: [
      {
        id: 'seg-26206-47-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los puntajes obtenidos en capacitaciones inciden en la carrera docente.',
    ],
    examples: [
      'Un docente de matemática realiza una especialización en enseñanza de la matemática ofrecida por el INFD, mejorando su posición en el escalafón.',
    ],
    relatedArticles: ['art-26206-47', 'art-26206-13'],
    jurisprudence: [],
    regulations: [],
    keywords: ['formación continua', 'capacitación docente', 'INFD', 'postítulos'],
    order: 7.88,
    segments: [
      {
        id: 'seg-26206-48-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La formación continua incide en el progreso dentro de la carrera docente.',
    ],
    examples: [
      'Un maestro excelente puede ascender en el escalafón por mérito pedagógico sin tener que ser director.',
    ],
    relatedArticles: ['art-26206-48', 'art-26206-13'],
    jurisprudence: [],
    regulations: [],
    keywords: ['carrera docente', 'función de enseñanza', 'conducción escolar', 'escalafón'],
    order: 7.89,
    segments: [
      {
        id: 'seg-26206-49-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Estado Nacional transfiere fondos a provincias que no pueden solventar el mínimo del CFE.',
    ],
    examples: [
      'El CFE vota un salario mínimo docente; una provincia que paga menos recibe un complemento del Estado Nacional para alcanzar ese piso.',
    ],
    relatedArticles: ['art-26206-9', 'art-26206-13'],
    jurisprudence: [],
    regulations: ['Ley 25.919 (Fondo Nacional de Incentivo Docente)'],
    keywords: ['salario docente', 'salario mínimo', 'garantía salarial', 'CFE'],
    order: 7.90,
    segments: [
      {
        id: 'seg-26206-50-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-10', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['gestión privada', 'supervisión', 'autorización', 'aranceles', 'escuelas privadas'],
    order: 7.91,
    segments: [
      {
        id: 'seg-26206-51-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-51', 'art-26206-9'],
    jurisprudence: [],
    regulations: [],
    keywords: ['subvención', 'aporte estatal', 'escuelas privadas', 'no lucro', 'aranceles'],
    order: 7.92,
    segments: [
      {
        id: 'seg-26206-52-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-51', 'art-26206-92'],
    jurisprudence: [],
    regulations: [],
    keywords: ['obligaciones escuelas privadas', 'contenidos comunes', 'ESI', 'información', 'cumplimiento'],
    order: 7.93,
    segments: [
      {
        id: 'seg-26206-53-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-5', 'art-26206-45'],
    jurisprudence: [],
    regulations: [],
    keywords: ['organismos de consulta', 'participación', 'comunidad educativa', 'docentes', 'alumnos', 'familias'],
    order: 7.94,
    segments: [
      {
        id: 'seg-26206-54-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los resultados de la evaluación deben orientar las políticas: no son un ranking, son un diagnóstico.',
      'La evaluación incluye tanto resultados de aprendizaje como factores institucionales y contextuales.',
    ],
    examples: [
      'Las pruebas Aprender evalúan anualmente las competencias en Lengua y Matemática de estudiantes de 3ro y 6to primario y 3ro secundario en todo el país.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['evaluación educativa', 'pruebas Aprender', 'diagnóstico', 'orientación de políticas', 'calidad educativa'],
    order: 7.95,
    segments: [
      {
        id: 'seg-26206-55-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Estado no puede cerrar una escuela con malos resultados: debe reforzarla con recursos.',
      'Los rankings de escuelas basados en pruebas estandarizadas contradicen el espíritu de este artículo.',
    ],
    examples: [
      'Una escuela con resultados bajos en las pruebas Aprender recibe apoyo pedagógico y recursos adicionales; no es sancionada ni publicada negativamente.',
    ],
    relatedArticles: ['art-26206-55', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['evaluación educativa', 'mejora', 'resultados públicos', 'no punitivismo', 'diagnóstico'],
    order: 7.96,
    segments: [
      {
        id: 'seg-26206-56-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-55', 'art-26206-45'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sistema de información educativa', 'estadísticas', 'datos educativos', 'diagnóstico', 'DiNNIE'],
    order: 7.97,
    segments: [
      {
        id: 'seg-26206-57-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los docentes deben recibir formación para usar TIC pedagógicamente.',
      'La conectividad a internet en escuelas es un derecho educativo bajo este artículo.',
    ],
    examples: [
      'El programa Conectar Igualdad, que entregó millones de netbooks a estudiantes secundarios, es la implementación de este artículo.',
    ],
    relatedArticles: ['art-26206-7', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['TIC', 'tecnología educativa', 'Conectar Igualdad', 'internet', 'conectividad escolar'],
    order: 7.98,
    segments: [
      {
        id: 'seg-26206-58-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Estado Nacional puede financiar obras de infraestructura escolar en provincias con menos recursos.',
      'Las escuelas con edificios en mal estado pueden exigir obras al Estado.',
    ],
    examples: [
      'Una escuela sin calefacción en una zona fría del sur del país tiene derecho a que el Estado provea equipamiento o realice obras para garantizar condiciones mínimas.',
    ],
    relatedArticles: ['art-26206-4', 'art-26206-9'],
    jurisprudence: [],
    regulations: [],
    keywords: ['infraestructura escolar', 'seguridad', 'higiene', 'accesibilidad', 'condiciones materiales'],
    order: 11,
    segments: [
      {
        id: 'seg-26206-59-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las bibliotecas escolares deben estar actualizadas y accesibles para todos los alumnos.',
      'Los estados provinciales pueden complementar con programas propios de libros gratuitos.',
    ],
    examples: [
      'El Ministerio de Educación distribuye libros de texto gratuitos para alumnos de primaria de sectores vulnerables al inicio de cada año escolar.',
    ],
    relatedArticles: ['art-26206-59', 'art-26206-7'],
    jurisprudence: [],
    regulations: [],
    keywords: ['libros de texto', 'materiales didácticos', 'gratuidad', 'bibliotecas escolares', 'acceso'],
    order: 12,
    segments: [
      {
        id: 'seg-26206-60-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Programa de Comedores Escolares del Estado Nacional cofinancia con las provincias.',
      'Un alumno que no come no puede aprender: el comedor es parte de la garantía del derecho a la educación.',
    ],
    examples: [
      'Una escuela primaria en un barrio vulnerable recibe financiamiento estatal para proveer almuerzo a todos sus alumnos.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-59'],
    jurisprudence: [],
    regulations: [],
    keywords: ['comedor escolar', 'copa de leche', 'vulnerabilidad', 'nutrición', 'asistencia escolar'],
    order: 13,
    segments: [
      {
        id: 'seg-26206-61-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Estado Nacional puede cofinanciar el transporte escolar rural.',
      'La falta de transporte puede ser invocada como incumplimiento de la obligatoriedad escolar por parte del Estado.',
    ],
    examples: [
      'Un servicio de transporte escolar rural lleva a alumnos de una comunidad a 20 km a la escuela más cercana, financiado por el gobierno provincial.',
    ],
    relatedArticles: ['art-26206-37', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['transporte escolar', 'zonas rurales', 'gratuidad', 'distancia', 'acceso'],
    order: 14,
    segments: [
      {
        id: 'seg-26206-62-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La Asignación Universal por Hijo (AUH) tiene condicionalidad educativa: el alumno debe asistir a la escuela.',
      'Los estados provinciales tienen sus propios programas de becas complementarios.',
    ],
    examples: [
      'Un adolescente de 17 años de familia vulnerable recibe una beca que le permite no trabajar y continuar el secundario.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-79'],
    jurisprudence: [],
    regulations: [],
    keywords: ['becas', 'apoyo económico', 'permanencia', 'Progresar', 'AUH', 'abandono escolar'],
    order: 15,
    segments: [
      {
        id: 'seg-26206-63-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los programas de becas de intercambio (Erasmus+ para Argentina, MARCA) tienen base en este artículo.',
      'La homologación de títulos permite que profesionales de otros países ejerzan en Argentina.',
    ],
    examples: [
      'El acuerdo de reconocimiento mutuo de títulos de grado en el Mercosur permite que un médico uruguayo ejerza en Argentina con su título reconocido.',
    ],
    relatedArticles: ['art-26206-5', 'art-26206-15'],
    jurisprudence: [],
    regulations: [],
    keywords: ['cooperación internacional', 'Mercosur Educativo', 'homologación de títulos', 'intercambio', 'OEI'],
    order: 16,
    segments: [
      {
        id: 'seg-26206-64-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los programas de formación profesional del INET y el Ministerio de Trabajo tienen base en este artículo.',
      'Los convenios colectivos de trabajo pueden incluir instancias de formación con reconocimiento educativo.',
    ],
    examples: [
      'Un trabajador gastronómico con 15 años de experiencia puede obtener un certificado de cocinero a través del sistema de certificación de competencias laborales.',
    ],
    relatedArticles: ['art-26206-30', 'art-26206-8'],
    jurisprudence: [],
    regulations: [],
    keywords: ['educación y trabajo', 'certificación de saberes', 'experiencia laboral', 'formación profesional', 'INET'],
    order: 17,
    segments: [
      {
        id: 'seg-26206-65-1',
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-11', 'art-26206-92'],
    jurisprudence: [],
    regulations: ['Ley 25.675 (Ley General del Ambiente)', 'Ley 27.621 (Educación Ambiental Integral)'],
    keywords: ['educación ambiental', 'medio ambiente', 'contenidos curriculares', 'Ley General del Ambiente', 'sustentabilidad'],
    order: 18,
    segments: [
      {
        id: 'seg-26206-66-1',
        ...
        references: ['Ley 25.675', 'Ley 27.621'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'El énfasis en secundaria responde a que los adolescentes son los más expuestos a accidentes de tránsito.',
      'La Agencia Nacional de Seguridad Vial puede proveer materiales y capacitaciones a las escuelas.',
    ],
    examples: [
      'Una escuela secundaria incluye en su currículo de tercer año una unidad sobre seguridad vial, alcoholemia y primeros auxilios en accidentes.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-92'],
    jurisprudence: [],
    regulations: [],
    keywords: ['educación vial', 'seguridad vial', 'accidentes de tránsito', 'adolescentes', 'ANSV'],
    order: 19,
    segments: [
      {
        id: 'seg-26206-67-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La salud mental es un contenido escolar: detección temprana de problemas en alumnos y acompañamiento.',
      'La coordinación con el Ministerio de Salud garantiza que los contenidos sean científicamente correctos.',
    ],
    examples: [
      'Una escuela secundaria implementa el Programa de Prevención de Adicciones del Ministerio de Salud integrado en sus clases de biología y educación física.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-92'],
    jurisprudence: [],
    regulations: ['Ley 26.150 (ESI)'],
    keywords: ['educación para la salud', 'adicciones', 'salud mental', 'alimentación', 'prevención'],
    order: 20,
    segments: [
      {
        id: 'seg-26206-68-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las cooperativas escolares son una herramienta pedagógica reconocida por la ley.',
      'El INAES (Instituto Nacional de Asociativismo y Economía Social) puede colaborar con el Ministerio en materiales didácticos.',
    ],
    examples: [
      'Una escuela secundaria técnica crea una cooperativa escolar de producción como proyecto educativo anual.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-54'],
    jurisprudence: [],
    regulations: [],
    keywords: ['cooperativismo', 'mutualismo', 'economía social', 'contenidos curriculares'],
    order: 21,
    segments: [
      {
        id: 'seg-26206-69-1',
        ...
        practicalExample:
          'En la materia Formación Ciudadana de 3er año secundario se incluye una unidad sobre cooperativas de trabajo y mutuales.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-2', 'art-26206-4', 'art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['acceso a la educación', 'inclusión', 'migrantes', 'documentación', 'universalidad'],
    order: 22,
    segments: [
      {
        id: 'seg-26206-70-1',
        ...
        practicalExample:
          'Una escuela fronteriza debe inscribir a niños de países limítrofes que viven en la zona aunque no tengan DNI argentino.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas deben crear instancias de participación estudiantil en la gestión institucional.',
      'La participación democrática en la escuela es un contenido pedagógico en sí mismo.',
    ],
    examples: [
      'Un colegio secundario habilita la formación del centro de estudiantes y le asigna un espacio físico y representación en el consejo de convivencia.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-54'],
    jurisprudence: [],
    regulations: [],
    keywords: ['participación estudiantil', 'centro de estudiantes', 'democracia', 'gestión escolar'],
    order: 23,
    segments: [
      {
        id: 'seg-26206-71-1',
        ...
        practicalExample:
          'La escuela organiza elecciones de delegados de curso y constituye un consejo estudiantil con representación en las decisiones institucionales.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Es el interlocutor nacional ante las provincias para todo lo referente a política educativa.',
      'Puede intervenir cuando una jurisdicción incumple obligaciones establecidas en la ley.',
    ],
    examples: [
      'El Ministerio de Educación dicta la Resolución CFE que establece los lineamientos curriculares para la educación secundaria en todo el país.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-116'],
    jurisprudence: [],
    regulations: [],
    keywords: ['autoridad de aplicación', 'ministerio de educación', 'competencia nacional'],
    order: 24,
    segments: [
      {
        id: 'seg-26206-72-1',
        ...
        practicalExample:
          'Cuando una provincia no implementa la obligatoriedad del nivel secundario, el Ministerio nacional puede requerirle un plan de acción.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los convenios Nación-Provincia son el mecanismo formal para transferir fondos y responsabilidades.',
      'La investigación educativa financiada por el Ministerio orienta la política pública.',
    ],
    examples: [
      'El Ministerio celebra un convenio con la provincia de Chaco para implementar el Programa de Jornada Extendida en 50 escuelas primarias.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-72'],
    jurisprudence: [],
    regulations: [],
    keywords: ['ministerio de educación', 'atribuciones', 'coordinación', 'lineamientos', 'convenios'],
    order: 25,
    segments: [
      {
        id: 'seg-26206-73-1',
        ...
        practicalExample:
          'En ejercicio de su atribución de fijar lineamientos, el Ministerio aprueba con el CFE los Núcleos de Aprendizajes Prioritarios (NAP) que rigen en todo el país.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-45', 'art-26206-72', 'art-26206-73'],
    jurisprudence: [],
    regulations: [],
    keywords: ['jurisdicciones', 'provincias', 'autonomía provincial', 'currículo jurisdiccional', 'gestión escolar'],
    order: 26,
    segments: [
      {
        id: 'seg-26206-74-1',
        ...
        practicalExample:
          'La provincia de Mendoza dicta la Resolución que aprueba el nuevo diseño curricular de la escuela primaria mendocina, compatible con los NAP del CFE.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-47', 'art-26206-74'],
    jurisprudence: [],
    regulations: [],
    keywords: ['institutos de formación docente', 'IFD', 'jurisdicciones', 'educación superior'],
    order: 27,
    segments: [
      {
        id: 'seg-26206-75-1',
        ...
        practicalExample:
          'La Dirección de Educación Superior de la provincia de Entre Ríos realiza la supervisión anual de los IFD provinciales y eleva informe al INFD.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-9', 'art-26206-79'],
    jurisprudence: [],
    regulations: [],
    keywords: ['financiamiento educativo', 'responsabilidad indelegable', 'Estado nacional', 'equidad territorial'],
    order: 28,
    segments: [
      {
        id: 'seg-26206-76-1',
        ...
        practicalExample:
          'La Nación transfiere el Fondo de Compensación Salarial Docente a provincias con menor capacidad fiscal para que ningún docente cobre menos del salario mínimo nacional.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Ministerio de Educación debe justificar ante el Parlamento las asignaciones presupuestarias.',
      'La Ley 26.075 (de Financiamiento Educativo) establece metas específicas de inversión que deben respetarse.',
    ],
    examples: [
      'El Ministerio de Educación envía antes del 15 de septiembre la propuesta de presupuesto del sector educativo para el año siguiente al Ministerio de Economía para su inclusión en el Presupuesto Nacional.',
    ],
    relatedArticles: ['art-26206-9', 'art-26206-76'],
    jurisprudence: [],
    regulations: ['Ley 26.075 de Financiamiento Educativo', 'Ley 24.156 de Administración Financiera'],
    keywords: ['presupuesto educativo', 'congreso', 'financiamiento', 'ley de administración financiera'],
    order: 29,
    segments: [
      {
        id: 'seg-26206-77-1',
        ...
        practicalExample:
          'Antes del 15 de septiembre, el Ministerio de Educación eleva al Congreso el detalle del presupuesto educativo del año siguiente para su aprobación.',
        references: ['Ley 24.156 art. 26', 'Ley 26.075'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-26206-55', 'art-26206-57'],
    jurisprudence: [],
    regulations: [],
    keywords: ['información educativa', 'estadísticas', 'transparencia', 'indicadores', 'rendición de cuentas'],
    order: 30,
    segments: [
      {
        id: 'seg-26206-78-1',
        ...
        practicalExample:
          'El Ministerio publica en su sitio web el informe anual con la matrícula por nivel y provincia, el gasto por alumno y los resultados de las evaluaciones Aprender.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'El Plan Nacional de Infraestructura Escolar para zonas rurales responde a este mandato.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['igualdad educativa', 'discriminación', 'inclusión', 'políticas afirmativas', 'marginalización'],
    order: 8,
    segments: [
      {
        id: 'seg-26206-79-1',
        ...
        practicalExample:
          'El Estado debe proveer becas, transporte y comedor escolar especialmente en zonas con alta vulnerabilidad para garantizar igualdad real de oportunidades.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas deben identificar alumnos en riesgo y articular con programas de apoyo.',
      'Los programas deben priorizarse en zonas de mayor vulnerabilidad social.',
    ],
    examples: [
      'El Programa Progresar (creado en 2014) otorga becas a jóvenes de 18 a 24 años para que terminen sus estudios secundarios o universitarios.',
    ],
    relatedArticles: ['art-26206-79', 'art-26206-63'],
    jurisprudence: [],
    regulations: [],
    keywords: ['abandono escolar', 'vulnerabilidad social', 'programas de apoyo', 'retención escolar'],
    order: 31,
    segments: [
      {
        id: 'seg-26206-80-1',
        ...
        practicalExample:
          'El Ministerio lanza el Programa Nacional de Inclusión Educativa para jóvenes que abandonaron la secundaria, ofreciéndoles tutores y becas para reincorporarse.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El esfuerzo presupuestario local se incorpora para evitar que la compensación nacional desincentive la inversión provincial.',
      'Los indicadores de eficiencia (repitencia, abandono, egreso) determinan parcialmente la distribución.',
    ],
    examples: [
      'La Nación distribuye el Fondo de Compensación Salarial Docente asignando más recursos a las provincias con mayor brecha salarial y menor capacidad fiscal.',
    ],
    relatedArticles: ['art-26206-79', 'art-26206-80'],
    jurisprudence: [],
    regulations: ['Ley 26.075 de Financiamiento Educativo'],
    keywords: ['compensación educativa', 'distribución fondos', 'vulnerabilidad', 'equidad territorial'],
    order: 32,
    segments: [
      {
        id: 'seg-26206-81-1',
        ...
        practicalExample:
          'La provincia de Formosa recibe más fondos de compensación que la de Buenos Aires porque tiene mayor proporción de alumnos vulnerables y menores recursos fiscales propios.',
        references: ['Ley 26.075'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-26206-4', 'art-26206-79', 'art-26206-80'],
    jurisprudence: [],
    regulations: [],
    keywords: ['calidad educativa', 'igualdad', 'condiciones materiales', 'origen social', 'equidad'],
    order: 33,
    segments: [
      {
        id: 'seg-26206-82-1',
        ...
        practicalExample:
          'El Ministerio distribuye equipamiento tecnológico (Programa Conectar Igualdad) prioritariamente a escuelas secundarias públicas de zonas vulnerables para reducir la brecha digital.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los internos pueden cursar desde nivel primario hasta universitario dentro de los establecimientos.',
      'La educación en contextos de encierro es una modalidad específica del sistema educativo nacional.',
    ],
    examples: [
      'Un interno en el Complejo Penitenciario Federal puede inscribirse en la UBA a través del programa UBAXXII y cursar materias universitarias en la cárcel.',
    ],
    relatedArticles: ['art-26206-41', 'art-26206-42'],
    jurisprudence: [],
    regulations: [],
    keywords: ['privación de libertad', 'cárceles', 'educación en contextos de encierro', 'derechos de internos'],
    order: 34,
    segments: [
      {
        id: 'seg-26206-83-1',
        ...
        practicalExample:
          'Una persona detenida en una comisaría durante 30 días puede solicitar acceso a materiales educativos y el Estado está obligado a facilitarlos.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los resultados de las evaluaciones deben publicarse y usarse para mejorar las políticas.',
      'Las jurisdicciones provinciales participan en las evaluaciones pero el marco nacional es del Ministerio.',
    ],
    examples: [
      'El Ministerio aplica cada dos años el operativo Aprender en escuelas primarias y secundarias de todo el país para medir los niveles de lectura y matemática.',
    ],
    relatedArticles: ['art-26206-55', 'art-26206-56', 'art-26206-57'],
    jurisprudence: [],
    regulations: [],
    keywords: ['evaluación educativa', 'aprender', 'ministerio de educación', 'política de evaluación'],
    order: 35,
    segments: [
      {
        id: 'seg-26206-84-1',
        ...
        practicalExample:
          'El Ministerio diseña el operativo Aprender, lo aplica en todo el país y publica los resultados desagregados por provincia, sector y nivel para orientar las políticas.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La información sobre logros de aprendizaje es un insumo para la formación docente continua.',
      'La sociedad tiene derecho a conocer los resultados de la evaluación del sistema educativo.',
    ],
    examples: [
      'Tras el operativo Aprender, el Ministerio publica los resultados y las jurisdicciones con peores resultados en matemática reciben asistencia técnica y recursos adicionales.',
    ],
    relatedArticles: ['art-26206-84', 'art-26206-55'],
    jurisprudence: [],
    regulations: [],
    keywords: ['evaluación educativa', 'objetivos', 'aprendizajes', 'transparencia', 'mejora continua'],
    order: 36,
    segments: [
      {
        id: 'seg-26206-85-1',
        ...
        practicalExample:
          'Los resultados del operativo Aprender en matemática secundaria llevan al INFD a rediseñar el módulo de didáctica de matemática en los IFD.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El organismo tiene autonomía técnica para garantizar la imparcialidad de los resultados.',
      'Puede articular con organismos internacionales de evaluación (PISA, LLECE).',
    ],
    examples: [
      'El INEE diseña el marco de referencia del operativo Aprender, define los ítems y garantiza que los resultados sean comparables entre años.',
    ],
    relatedArticles: ['art-26206-84', 'art-26206-85'],
    jurisprudence: [],
    regulations: [],
    keywords: ['INEE', 'Instituto Nacional de Evaluación Educativa', 'evaluación', 'organismo'],
    order: 37,
    segments: [
      {
        id: 'seg-26206-86-1',
        ...
        practicalExample:
          'El INEE es quien publica el informe técnico del operativo Aprender con los niveles de desempeño y la evolución histórica de los resultados.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los instrumentos diseñados por el INEE son comparables entre jurisdicciones y entre años.',
      'Las provincias que quieran crear sus propias evaluaciones pueden contar con asistencia técnica del INEE.',
    ],
    examples: [
      'El INEE asesora a la provincia de Santa Cruz en el diseño de una evaluación diagnóstica propia para 3er grado de primaria, compatible con el marco nacional.',
    ],
    relatedArticles: ['art-26206-86', 'art-26206-55'],
    jurisprudence: [],
    regulations: [],
    keywords: ['INEE', 'funciones', 'estándares', 'instrumentos de evaluación', 'asesoramiento jurisdiccional'],
    order: 38,
    segments: [
      {
        id: 'seg-26206-87-1',
        ...
        practicalExample:
          'El INEE publica los marcos de referencia con los descriptores de los cuatro niveles de desempeño (Avanzado, Satisfactorio, Básico, Por debajo del básico) que se usan en Aprender.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Ninguna jurisdicción puede ser impuesta en sus decisiones educativas; requiere consenso federal.',
      'El Ministerio nacional propone, el CFE valida o modifica.',
    ],
    examples: [
      'El Ministerio propone los Núcleos de Aprendizajes Prioritarios (NAP) y el CFE los aprueba como resolución, obligatoria para todas las provincias.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-72'],
    jurisprudence: [],
    regulations: [],
    keywords: ['gobierno del sistema educativo', 'ministerio de educación', 'CFE', 'federalismo'],
    order: 39,
    segments: [
      {
        id: 'seg-26206-88-1',
        ...
        practicalExample:
          'La Resolución CFE 93/09 aprobó los lineamientos curriculares nacionales para la educación secundaria con la firma de los 24 ministros de educación jurisdiccionales.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Ministerio puede retirar la validez nacional a instituciones que no cumplan los requisitos.',
      'Los títulos de IFD provinciales son reconocidos en todo el país por esta atribución.',
    ],
    examples: [
      'Un maestro que se recibió en Salta puede ejercer la docencia en cualquier provincia del país sin necesitar una revalidación provincial de su título.',
    ],
    relatedArticles: ['art-26206-72', 'art-26206-47'],
    jurisprudence: [],
    regulations: [],
    keywords: ['validez nacional', 'títulos', 'certificados', 'acreditación', 'reconocimiento'],
    order: 40,
    segments: [
      {
        id: 'seg-26206-89-1',
        ...
        practicalExample:
          'Una profesora de matemáticas recibida en el IFD de Neuquén puede inscribirse en el escalafón docente de la provincia de Buenos Aires sin revalidar su título.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las universidades pueden canalizar sus posiciones sobre política educativa a través del CIN.',
      'El asesoramiento es no vinculante: el Ministerio escucha pero decide.',
    ],
    examples: [
      'Cuando el Ministerio propone modificar los requisitos de acreditación de carreras de medicina, el CIN emite un dictamen técnico que el Ministerio considera antes de decidir.',
    ],
    relatedArticles: ['art-26206-27', 'art-26206-28'],
    jurisprudence: [],
    regulations: [],
    keywords: ['CIN', 'Consejo de Universidades', 'educación superior', 'asesoramiento'],
    order: 41,
    segments: [
      {
        id: 'seg-26206-90-1',
        ...
        practicalExample:
          'El CIN emite resolución recomendando al Ministerio mantener la duración mínima de las carreras de grado en 4 años ante una propuesta de reducción.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La estructura educativa vuelve a ser primaria y secundaria (con la obligatoriedad del secundario completo).',
      'Las normas complementarias de la Ley 24.195 que no contradigan la nueva ley mantienen vigencia transitoriamente.',
    ],
    examples: [
      'Desde la vigencia de la Ley 26.206, las escuelas que tenían estructura EGB/Polimodal debieron adecuarse al sistema de primaria (6 o 7 años) y secundaria (5 o 6 años) según la jurisdicción.',
    ],
    relatedArticles: [],
    jurisprudence: [],
    regulations: [],
    keywords: ['derogación', 'ley federal de educación', 'ley 24195', 'EGB', 'polimodal'],
    order: 42,
    segments: [
      {
        id: 'seg-26206-91-1',
        ...
        practicalExample:
          'Desde 2006, la estructura del sistema escolar ya no es EGB 1, 2, 3 + Polimodal sino Nivel Primario y Nivel Secundario, con el secundario completo obligatorio.',
        references: ['Ley 24.195', 'Ley 25.864', 'Ley 25.981'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    examples: [
      ...
      'La efeméride del 24 de marzo es obligatoria en todas las escuelas del país.',
    ],
    relatedArticles: ['art-26206-11'],
    jurisprudence: [],
    regulations: ['Ley 26.150 (Programa Nacional de Educación Sexual Integral)'],
    keywords: ['ESI', 'educación sexual integral', 'Malvinas', 'DDHH', 'terrorismo de Estado', 'contenidos curriculares comunes'],
    order: 9,
    segments: [
      {
        id: 'seg-26206-92-1',
        ...
        practicalExample:
          'Toda escuela, pública o privada, debe conmemorar el 24 de marzo y enseñar sobre la última dictadura militar como contenido curricular obligatorio.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-66'],
    jurisprudence: [],
    regulations: [],
    keywords: ['medio ambiente', 'desarrollo sustentable', 'currículo', 'patrimonio natural'],
    order: 43,
    segments: [
      {
        id: 'seg-26206-93-1',
        ...
        practicalExample:
          'Una escuela primaria realiza un proyecto anual de huerta escolar vinculado al currículo de Ciencias Naturales como aplicación de los contenidos de sustentabilidad.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-58'],
    jurisprudence: [],
    regulations: ['Ley 26.522 de Servicios de Comunicación Audiovisual'],
    keywords: ['medios de comunicación', 'contenidos educativos', 'programación', 'ENACOM'],
    order: 44,
    segments: [
      {
        id: 'seg-26206-94-1',
        ...
        practicalExample:
          'Un canal de televisión abierta debe incluir en su grilla programas educativos y culturales, no solo entretenimiento comercial.',
        references: ['Ley 26.522'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-26206-12', 'art-26206-13'],
    jurisprudence: [],
    regulations: [],
    keywords: ['sindicatos docentes', 'CTERA', 'consulta gremial', 'participación', 'política educativa'],
    order: 45,
    segments: [
      {
        id: 'seg-26206-95-1',
        ...
        practicalExample:
          'El Ministerio convoca a CTERA y los demás gremios nacionales a participar de la discusión sobre los nuevos lineamientos de la formación docente inicial.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las paritarias provinciales negocian por encima del piso nacional.',
      'La Paritaria Nacional Docente se reúne anualmente para discutir el salario y las condiciones laborales.',
    ],
    examples: [
      'En febrero de cada año, el Ministerio de Educación convoca la Paritaria Nacional Docente donde se fija el salario mínimo garantizado (FONID) que toda provincia debe abonar.',
    ],
    relatedArticles: ['art-26206-12', 'art-26206-73'],
    jurisprudence: [],
    regulations: ['Ley 26.075 de Financiamiento Educativo'],
    keywords: ['paritaria docente', 'salario mínimo docente', 'carrera docente', 'FONID'],
    order: 46,
    segments: [
      {
        id: 'seg-26206-96-1',
        ...
        practicalExample:
          'El Ministerio publica en febrero la resolución que actualiza el salario mínimo docente nacional en $X, que ninguna provincia puede pagar por debajo de esa cifra.',
        references: ['Ley 26.075'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-51', 'art-26206-96'],
    jurisprudence: [],
    regulations: [],
    keywords: ['docentes privados', 'igualdad', 'condiciones laborales', 'gestión privada'],
    order: 47,
    segments: [
      {
        id: 'seg-26206-97-1',
        ...
        practicalExample:
          'Un docente de un colegio privado subvencionado tiene derecho a la estabilidad laboral y no puede ser despedido por ejercer el derecho a huelga.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-51', 'art-26206-74'],
    jurisprudence: [],
    regulations: [],
    keywords: ['gestión privada', 'normas provinciales', 'habilitación', 'regulación provincial'],
    order: 48,
    segments: [
      {
        id: 'seg-26206-98-1',
        ...
        practicalExample:
          'Los requisitos de planta física para habilitar una escuela privada se rigen por el decreto reglamentario provincial de educación, no por la Ley 26.206.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-33', 'art-26206-34'],
    jurisprudence: [],
    regulations: ['Convención sobre los Derechos de las Personas con Discapacidad (Ley 26.378)'],
    keywords: ['discapacidad', 'inclusión educativa', 'apoyos', 'maestro integrador', 'accesibilidad'],
    order: 49,
    segments: [
      {
        id: 'seg-26206-99-1',
        ...
        practicalExample:
          'Un estudiante secundario con baja visión tiene derecho a recibir materiales en formato accesible (ampliados o en Braille) y a que el docente reciba orientación para adaptar su enseñanza.',
        references: ['Convención sobre los Derechos de las Personas con Discapacidad'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'El Programa Nacional de Educación Sexual Integral (Ley 26.150) define los lineamientos curriculares.',
      'Las escuelas no pueden negarse a implementar la ESI invocando razones religiosas o ideológicas.',
    ],
    examples: [
      'Una escuela de gestión religiosa está obligada a implementar la ESI con los lineamientos curriculares del Programa Nacional, ya que la ley no admite excepciones por ideario institucional.',
    ],
    relatedArticles: ['art-26206-92'],
    jurisprudence: [],
    regulations: ['Ley 26.150 de Educación Sexual Integral'],
    keywords: ['ESI', 'educación sexual integral', 'ley 26150', 'salud', 'derechos'],
    order: 50,
    segments: [
      {
        id: 'seg-26206-100-1',
        ...
        practicalExample:
          'Una escuela secundaria debe incluir la ESI en su PEI (Proyecto Educativo Institucional) con los lineamientos del Programa Nacional, sin importar si es pública o privada.',
        references: ['Ley 26.150'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La adecuación incluyó la estructura del sistema (primaria/secundaria), la obligatoriedad y los fines educativos.',
      'Las provincias que no adecuaron en plazo no podían acceder a determinados fondos nacionales.',
    ],
    examples: [
      'La provincia de Buenos Aires sancionó la Ley 13.688 en 2007 para adecuar su sistema educativo a la nueva ley nacional 26.206.',
    ],
    relatedArticles: ['art-26206-74', 'art-26206-91'],
    jurisprudence: [],
    regulations: [],
    keywords: ['adecuación jurisdiccional', 'plazo', 'leyes provinciales', 'compatibilidad'],
    order: 51,
    segments: [
      {
        id: 'seg-26206-101-1',
        ...
        practicalExample:
          'Buenos Aires sancionó la Ley 13.688 (2007) y Santa Fe la Ley 12.306 (2004 actualizada) para adaptar sus sistemas a la Ley 26.206.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Cada convenio puede incluir metas, plazos y mecanismos de evaluación del cumplimiento.',
      'Las provincias no pueden recibir determinados fondos sin firmar el convenio correspondiente.',
    ],
    examples: [
      'El Ministerio celebra un convenio con la provincia de Jujuy para implementar el programa de jornada extendida en 30 escuelas primarias con financiamiento nacional.',
    ],
    relatedArticles: ['art-26206-73', 'art-26206-101'],
    jurisprudence: [],
    regulations: [],
    keywords: ['convenios', 'implementación', 'nación-provincia', 'articulación federal'],
    order: 52,
    segments: [
      {
        id: 'seg-26206-102-1',
        ...
        practicalExample:
          'El convenio entre el Ministerio y la provincia de Misiones establece metas de reducción del abandono escolar en secundaria con financiamiento nacional y contrapartida provincial.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El informe es público y puede ser analizado por organizaciones de la sociedad civil.',
      'El Congreso puede interpelar al Ministro si el informe revela incumplimientos graves.',
    ],
    examples: [
      'El Ministerio de Educación presenta ante las comisiones de Educación de ambas cámaras el informe anual sobre cobertura, matrícula y obligatoriedad del nivel secundario.',
    ],
    relatedArticles: ['art-26206-78'],
    jurisprudence: [],
    regulations: [],
    keywords: ['rendición de cuentas', 'congreso', 'informe anual', 'control parlamentario'],
    order: 53,
    segments: [
      {
        id: 'seg-26206-103-1',
        ...
        practicalExample:
          'El Ministerio presenta en agosto el informe anual ante las comisiones de Educación del Senado y Diputados con datos sobre matrícula, egreso y financiamiento.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-51', 'art-26206-74', 'art-26206-98'],
    jurisprudence: [],
    regulations: [],
    keywords: ['escuelas privadas', 'autorización', 'habilitación', 'gestión privada', 'jurisdicciones'],
    order: 54,
    segments: [
      {
        id: 'seg-26206-104-1',
        ...
        practicalExample:
          'La provincia de Córdoba inspecciona el proyecto institucional, el plantel docente y la infraestructura antes de autorizar la apertura de un nuevo colegio privado.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas privadas que incumplan pueden perder la autorización de funcionamiento.',
      'Los padres pueden denunciar incumplimientos ante la autoridad educativa provincial.',
    ],
    examples: [
      'Un inspector provincial visita un colegio privado y detecta que tiene docentes sin título habilitante: la escuela debe regularizar la situación en un plazo o arriesga la pérdida de la autorización.',
    ],
    relatedArticles: ['art-26206-104', 'art-26206-74'],
    jurisprudence: [],
    regulations: [],
    keywords: ['supervisión escolar', 'escuelas privadas', 'inspección', 'control', 'habilitación'],
    order: 55,
    segments: [
      {
        id: 'seg-26206-105-1',
        ...
        practicalExample:
          'El inspector provincial detecta que un colegio privado no implementa la ESI y le notifica que debe presentar un plan de regularización en 30 días.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Se promueven intercambios estudiantiles y docentes con Brasil, Uruguay, Paraguay y Bolivia.',
      'Las escuelas de zonas de frontera pueden tener proyectos binacionales con escuelas del país limítrofe.',
    ],
    examples: [
      'Un alumno brasileño que se muda a Misiones puede inscribirse directamente en la escuela secundaria argentina con su certificado de estudios brasileño, sin necesidad de revalidación.',
    ],
    relatedArticles: ['art-26206-64'],
    jurisprudence: [],
    regulations: ['Acuerdo de Admisión de Títulos del MERCOSUR (Dec. 26/02)'],
    keywords: ['MERCOSUR', 'integración regional', 'zonas de frontera', 'reconocimiento de títulos'],
    order: 56,
    segments: [
      {
        id: 'seg-26206-106-1',
        ...
        practicalExample:
          'Una escuela en Paso de los Libres (Corrientes) desarrolla un proyecto educativo conjunto con su par de Uruguaiana (Brasil) sobre historia compartida del litoral.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El reconocimiento de saberes permite al adulto completar la educación obligatoria de forma más rápida.',
      'El Ministerio define los criterios y mecanismos de validación (exámenes, portafolios, etc.).',
    ],
    examples: [
      'Un cocinero con 20 años de experiencia pero sin secundaria completa puede acreditar sus saberes culinarios ante el sistema de educación técnico-profesional y obtener una certificación reconocida.',
    ],
    relatedArticles: ['art-26206-35', 'art-26206-65'],
    jurisprudence: [],
    regulations: [],
    keywords: ['reconocimiento de saberes', 'aprendizajes previos', 'acreditación', 'educación informal'],
    order: 57,
    segments: [
      {
        id: 'seg-26206-107-1',
        ...
        practicalExample:
          'Un mecánico autodidacta puede rendir exámenes libres ante el INET para acreditar sus saberes y obtener un certificado de la especialidad reconocido en todo el país.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-2'],
    jurisprudence: [],
    regulations: [],
    keywords: ['emergencia', 'continuidad pedagógica', 'educación a distancia', 'COVID-19'],
    order: 58,
    segments: [
      {
        id: 'seg-26206-108-1',
        ...
        practicalExample:
          'Durante el ASPO de 2020, el Ministerio lanzó el programa Seguimos Educando con transmisiones televisivas y materiales impresos distribuidos en hogares sin internet.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los clubes sociales y deportivos pueden articular con las escuelas en proyectos de educación física o artística.',
      'La educación no formal es reconocida como complementaria de la formal.',
    ],
    examples: [
      'El Museo Nacional de Bellas Artes desarrolla un programa educativo para escuelas secundarias de todo el país con visitas presenciales y materiales didácticos.',
    ],
    relatedArticles: ['art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['museos', 'educación no formal', 'organizaciones comunitarias', 'articulación', 'biblioteca'],
    order: 59,
    segments: [
      {
        id: 'seg-26206-109-1',
        ...
        practicalExample:
          'La Biblioteca Popular del barrio firma un convenio con dos escuelas primarias para el programa de animación a la lectura que complementa el currículo de Lengua.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los CAJ ofrecen talleres gratuitos de arte, deporte, comunicación y otras actividades.',
      'La participación en los CAJ contribuye a la retención y el compromiso de los jóvenes con la escuela.',
    ],
    examples: [
      'Un CAJ en una escuela secundaria de San Luis ofrece talleres de murga, fútbol, fotografía y programación en el contraturno escolar, con participación abierta a jóvenes de la comunidad.',
    ],
    relatedArticles: ['art-26206-23', 'art-26206-71'],
    jurisprudence: [],
    regulations: [],
    keywords: ['centros de actividades juveniles', 'CAJ', 'secundaria', 'contraturno', 'retención escolar'],
    order: 60,
    segments: [
      {
        id: 'seg-26206-110-1',
        ...
        practicalExample:
          'Un CAJ en una escuela de Santiago del Estero ofrece taller de teatro, guitarra y básquet en el contraturno; la participación aumentó la retención en un 15% según el informe provincial.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-35', 'art-26206-36'],
    jurisprudence: [],
    regulations: [],
    keywords: ['alfabetización', 'adultos', 'jóvenes', 'educación básica', 'CENS', 'escolaridad'],
    order: 61,
    segments: [
      {
        id: 'seg-26206-111-1',
        ...
        practicalExample:
          'El Plan FinEs permite a adultos que nunca terminaron el secundario cursarlo de forma gratuita en centros barriales con docentes especialmente formados para educación de adultos.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los resultados de la investigación educativa deben incidir en la formación docente y la política curricular.',
      'El CONICET y las universidades pueden articular con el Ministerio en investigación educativa.',
    ],
    examples: [
      'El Ministerio convoca a investigadores universitarios para un estudio sobre las causas del abandono escolar en el nivel secundario, cuyos resultados orientan el diseño de nuevas políticas de retención.',
    ],
    relatedArticles: ['art-26206-56', 'art-26206-73'],
    jurisprudence: [],
    regulations: [],
    keywords: ['investigación educativa', 'innovación pedagógica', 'evidencia', 'calidad', 'CONICET'],
    order: 62,
    segments: [
      {
        id: 'seg-26206-112-1',
        ...
        practicalExample:
          'El Ministerio financia un programa de investigación sobre enseñanza de matemáticas en escuelas rurales que incorpora los resultados al módulo de formación docente del INFD.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: [],
    jurisprudence: [],
    regulations: ['Ley 25.864 (garantía de 180 días de clase)'],
    keywords: ['calendario escolar', '180 días de clase', 'CFE', 'año lectivo'],
    order: 63,
    segments: [
      {
        id: 'seg-26206-113-1',
        ...
        practicalExample:
          'Una provincia que acumuló huelgas docentes y llegó al 30 de noviembre con solo 160 días debe programar clases en diciembre o enero para alcanzar el mínimo de 180.',
        references: ['Ley 25.864'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'Sin reglamentación, algunos artículos de la ley no podían ejecutarse operativamente.',
      'La reglamentación no puede ir más allá de lo que la ley autoriza ni restringir derechos que la ley otorga.',
    ],
    examples: [
      'El decreto reglamentario de la Ley 26.206 definió la composición y funcionamiento del CFE en detalle, complementando lo que la ley establecía en términos generales.',
    ],
    relatedArticles: ['art-26206-72'],
    jurisprudence: [],
    regulations: [],
    keywords: ['reglamentación', 'decreto reglamentario', 'poder ejecutivo', 'plazo'],
    order: 64,
    segments: [
      {
        id: 'seg-26206-114-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las jurisdicciones debían iniciar el proceso de adecuación desde esa fecha.',
      'Los derechos consagrados en la ley son exigibles desde esa fecha, aunque la implementación sea progresiva.',
    ],
    examples: [
      'Desde el 29 de diciembre de 2006, cualquier alumno puede invocar los derechos consagrados en la Ley 26.206 ante la autoridad educativa competente.',
    ],
    relatedArticles: ['art-26206-91', 'art-26206-101'],
    jurisprudence: [],
    regulations: [],
    keywords: ['vigencia', 'boletín oficial', 'promulgación', 'entrada en vigor'],
    order: 65,
    segments: [
      {
        id: 'seg-26206-115-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las pautas salariales docentes de la Paritaria Nacional son acordadas en el CFE.',
      'Los criterios de distribución del Fondo de Compensación Salarial son acordados en el CFE.',
    ],
    examples: [
      'El CFE aprueba por resolución los NAP de Matemática para el nivel primario, que son obligatorios para todos los diseños curriculares provinciales.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-72', 'art-26206-88'],
    jurisprudence: [],
    regulations: [],
    keywords: ['CFE', 'atribuciones', 'consejo federal de educación', 'políticas educativas', 'NAP'],
    order: 66,
    segments: [
      {
        id: 'seg-26206-116-1',
        ...
        practicalExample:
          'La Resolución CFE 93/09 aprobó los lineamientos curriculares nacionales para la educación secundaria: ese es el ejercicio concreto de la atribución de acordar contenidos curriculares comunes.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los 24 ministros provinciales tienen voz y voto en las decisiones del CFE.',
      'La presencia del rector de la UBA y del CIN vincula la educación superior universitaria con las decisiones del CFE.',
    ],
    examples: [
      'En cada reunión ordinaria del CFE, los 24 ministros provinciales de educación votan las resoluciones que determinan los lineamientos curriculares y las políticas educativas del país.',
    ],
    relatedArticles: ['art-26206-45', 'art-26206-116'],
    jurisprudence: [],
    regulations: [],
    keywords: ['CFE', 'composición', 'ministros provinciales', 'consejo federal', 'CIN'],
    order: 67,
    segments: [
      {
        id: 'seg-26206-117-1',
        ...
        practicalExample:
          'Cuando el CFE vota una resolución sobre el nuevo diseño de la escuela secundaria, los 24 ministros provinciales tienen voto y el resultado es vinculante para todo el sistema.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las reuniones del CFE tienen un reglamento interno que define quórum, votaciones y procedimientos.',
      'Las resoluciones aprobadas en Asamblea Federal son vinculantes para todas las jurisdicciones.',
    ],
    examples: [
      'En la Asamblea Federal de marzo, el CFE aprueba las resoluciones sobre inicio del ciclo lectivo, y en la de octubre, las sobre el cierre y balance del año escolar.',
    ],
    relatedArticles: ['art-26206-117', 'art-26206-116'],
    jurisprudence: [],
    regulations: [],
    keywords: ['asamblea federal', 'CFE', 'reuniones', 'resoluciones', 'reglamento'],
    order: 68,
    segments: [
      {
        id: 'seg-26206-118-1',
        ...
        practicalExample:
          'La Asamblea Federal del CFE de mayo aprueba por resolución los lineamientos para la educación en contextos de emergencia ante la proliferación de una enfermedad.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los 8 ministros provinciales representan a todas las regiones del país.',
      'Las decisiones del Comité Ejecutivo están sujetas a ratificación o revisión por la Asamblea Federal.',
    ],
    examples: [
      'Ante una situación de emergencia educativa en verano, el Comité Ejecutivo del CFE aprueba las medidas de continuidad pedagógica sin necesitar convocar a los 25 ministros.',
    ],
    relatedArticles: ['art-26206-117', 'art-26206-118'],
    jurisprudence: [],
    regulations: [],
    keywords: ['comité ejecutivo', 'CFE', 'gestión', 'representación regional'],
    order: 69,
    segments: [
      {
        id: 'seg-26206-119-1',
        ...
        practicalExample:
          'El Comité Ejecutivo del CFE aprueba en julio la resolución sobre el calendario de recuperación de días de clase perdidos por las inundaciones en el NEA.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La Secretaría General prepara los documentos y el orden del día de cada Asamblea Federal.',
      'Las resoluciones del CFE son numeradas y publicadas por la Secretaría General.',
    ],
    examples: [
      'La Secretaría General del CFE publica en el sitio web del Ministerio de Educación todas las resoluciones aprobadas, con su número, fecha y texto completo.',
    ],
    relatedArticles: ['art-26206-117', 'art-26206-118', 'art-26206-119'],
    jurisprudence: [],
    regulations: [],
    keywords: ['secretaría general', 'CFE', 'administración', 'ministerio de educación'],
    order: 70,
    segments: [
      {
        id: 'seg-26206-120-1',
        ...
        practicalExample:
          'La Secretaría General del CFE numera y publica la Resolución CFE 330/17 sobre evaluación educativa y la distribuye a todos los ministerios provinciales.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-2', 'art-26206-4', 'art-26206-76'],
    jurisprudence: [],
    regulations: [],
    keywords: ['responsabilidad estatal', 'gratuidad', 'equidad', 'educación de calidad', 'indelegable'],
    order: 71,
    segments: [
      {
        id: 'seg-26206-121-1',
        ...
        practicalExample:
          'Cuando una provincia elimina las horas de educación física por restricciones presupuestarias, está incumpliendo su responsabilidad indelegable de garantizar una educación integral.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-76', 'art-26206-77'],
    jurisprudence: [],
    regulations: [],
    keywords: ['fondos educativos', 'intangibilidad', 'embargo', 'afectación específica', 'FONID'],
    order: 72,
    segments: [
      {
        id: 'seg-26206-122-1',
        ...
        practicalExample:
          'Un acreedor del Estado provincial no puede ejecutar embargo sobre las transferencias del Ministerio de Educación nacional destinadas a pagar el salario docente del mes.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La meta del 6% del PBI en educación fue establecida por la Ley 26.075.',
      'Los mecanismos de distribución de fondos entre Nación y provincias están en la Ley 26.075.',
    ],
    examples: [
      'Argentina alcanzó en 2015 la meta del 6% del PBI destinado a educación que estableció la Ley 26.075, aunque con heterogeneidad entre provincias.',
    ],
    relatedArticles: ['art-26206-76', 'art-26206-77'],
    jurisprudence: [],
    regulations: ['Ley 26.075 de Financiamiento Educativo'],
    keywords: ['financiamiento educativo', 'ley 26075', '6% PBI', 'inversión educativa'],
    order: 73,
    segments: [
      {
        id: 'seg-26206-123-1',
        ...
        practicalExample:
          'La Ley 26.075 distribuyó la responsabilidad del financiamiento educativo: 40% a cargo de la Nación y 60% a cargo de las provincias, con metas anuales de incremento.',
        references: ['Ley 26.075'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La inflación debe compensarse con aumentos nominales para no caer por debajo del piso real.',
      'Si el presupuesto educativo real cae, el Estado incumple la ley y puede ser demandado.',
    ],
    examples: [
      'Si en 2023 el presupuesto educativo fue de $1 billón con una inflación del 100%, en 2024 debe ser al menos de $2 billones para no caer en términos reales.',
    ],
    relatedArticles: ['art-26206-76', 'art-26206-123'],
    jurisprudence: [],
    regulations: [],
    keywords: ['no regresividad', 'presupuesto educativo', 'términos reales', 'inflación', 'piso mínimo'],
    order: 74,
    segments: [
      {
        id: 'seg-26206-124-1',
        ...
        practicalExample:
          'Si el Ministerio de Educación recibe $500.000M en 2024 y la inflación es del 50%, en 2025 debe recibir al menos $750.000M para no caer en términos reales.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El CFE puede verificar la inversión educativa jurisdiccional y requerir información a las provincias.',
      'Los mecanismos de control permiten detectar desvíos o subejecuciones del presupuesto educativo.',
    ],
    examples: [
      'El Ministerio de Educación publica en su sitio web el cuadro de ejecución presupuestaria mensual, detallando cuánto se gastó en cada programa educativo.',
    ],
    relatedArticles: ['art-26206-78', 'art-26206-123'],
    jurisprudence: [],
    regulations: [],
    keywords: ['control presupuestario', 'transparencia', 'inversión educativa', 'CFE', 'ministerio'],
    order: 75,
    segments: [
      {
        id: 'seg-26206-125-1',
        ...
        practicalExample:
          'El CFE crea un sistema de reporte anual donde cada provincia informa cuánto invirtió en educación y en qué, para verificar el cumplimiento de las metas de la Ley 26.075.',
        references: ['Ley 26.075'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los medios de comunicación deben contribuir activamente a los fines educativos.',
      'Las familias no solo tienen derechos en educación sino también responsabilidades de colaborar con la escuela.',
    ],
    examples: [
      'Una empresa que implementa pasantías para estudiantes de escuelas técnicas está cumpliendo su responsabilidad de colaborar con los objetivos educativos de la ley.',
    ],
    relatedArticles: ['art-26206-14', 'art-26206-94'],
    jurisprudence: [],
    regulations: [],
    keywords: ['responsabilidad social', 'familia', 'comunidad', 'empresas', 'medios', 'gremios'],
    order: 76,
    segments: [
      {
        id: 'seg-26206-126-1',
        ...
        practicalExample:
          'Un gremio sindical que negocia con una empresa la implementación de un programa de finalización del secundario para sus trabajadores está cumpliendo esta responsabilidad social.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La denuncia es obligatoria aunque el docente no tenga certeza: la sospecha fundada es suficiente.',
      'El incumplimiento de la obligación de denuncia puede generar responsabilidad penal o disciplinaria.',
    ],
    examples: [
      'Una maestra detecta marcas de golpes en un alumno de 7 años. Tiene la obligación legal de denunciarlo ante la autoridad de protección de derechos de la provincia (SENAF, Defensoría, etc.).',
    ],
    relatedArticles: [],
    jurisprudence: [],
    regulations: ['Ley 26.061 de Protección Integral de Niños, Niñas y Adolescentes'],
    keywords: ['obligación de denuncia', 'docentes', 'protección de derechos', 'vulneración', 'abuso'],
    order: 77,
    segments: [
      {
        id: 'seg-26206-127-1',
        ...
        practicalExample:
          'Un profesor de educación física nota que una alumna tiene moretones recurrentes y la niña relata maltrato. El profesor está obligado a denunciar ante la Defensoría de Niñas, Niños y Adolescentes de la jurisdicción.',
        references: ['Ley 26.061'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-26206-89'],
    jurisprudence: [],
    regulations: [],
    keywords: ['fuerzas armadas', 'fuerzas de seguridad', 'educación militar', 'colegios militares'],
    order: 78,
    segments: [
      {
        id: 'seg-26206-128-1',
        ...
        practicalExample:
          'El Instituto de Enseñanza Superior del Ejército debe seguir los lineamientos nacionales de formación docente del INFD, ya que sus egresados tendrán título nacional válido.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-94'],
    jurisprudence: [],
    regulations: ['Ley 26.522 de Servicios de Comunicación Audiovisual'],
    keywords: ['medios de comunicación', 'horario de protección', 'contenidos infantiles', 'ENACOM'],
    order: 79,
    segments: [
      {
        id: 'seg-26206-129-1',
        ...
        practicalExample:
          'Un canal de TV que emite una escena de violencia explícita a las 19 hs. puede ser sancionado por ENACOM por violación del horario de protección al menor.',
        references: ['Ley 26.522'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los alumnos tienen derecho a participar en los consejos de convivencia y otras instancias institucionales.',
      'La orientación vocacional es un servicio que las escuelas deben ofrecer (no solo las privadas).',
    ],
    examples: [
      'Un alumno de origen boliviano que recibe burlas por su acento puede denunciar el hecho ante la dirección de la escuela invocando su derecho a no ser discriminado.',
    ],
    relatedArticles: ['art-26206-11'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derechos de los alumnos', 'identidad cultural', 'no discriminación', 'orientación vocacional'],
    order: 80,
    segments: [
      {
        id: 'seg-26206-130-1',
        ...
        practicalExample:
          'Un estudiante de secundaria solicita al gabinete escolar orientación vocacional antes de elegir carrera universitaria, ejerciendo el derecho que este artículo le otorga.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El daño a los bienes escolares puede dar lugar a responsabilidad civil de los padres.',
      'Las normas de convivencia son obligatorias y deben ser conocidas por todos los alumnos.',
    ],
    examples: [
      'Un reglamento de convivencia escolar que prohíbe el uso de celulares en clase es una norma obligatoria que los alumnos deben cumplir en virtud de este artículo.',
    ],
    relatedArticles: ['art-26206-130'],
    jurisprudence: [],
    regulations: [],
    keywords: ['obligaciones de los alumnos', 'asistencia', 'convivencia', 'diversidad', 'bienes escolares'],
    order: 81,
    segments: [
      {
        id: 'seg-26206-131-1',
        ...
        practicalExample:
          'Un alumno que rompe intencionalmente una computadora de la escuela tiene responsabilidad civil, y sus padres deben responder por el daño según el Código Civil.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las sanciones deben ser proporcionales y respetar el derecho de defensa del alumno.',
      'Los reglamentos no pueden prohibir prácticas religiosas, culturales o políticas legítimas.',
    ],
    examples: [
      'Un reglamento que expulsa definitivamente a un alumno sin escucharlo viola el principio de debido proceso establecido en los lineamientos del CFE para los regímenes de convivencia.',
    ],
    relatedArticles: ['art-26206-130', 'art-26206-131'],
    jurisprudence: [],
    regulations: [],
    keywords: ['convivencia escolar', 'reglamento', 'sanciones', 'participación', 'debido proceso'],
    order: 82,
    segments: [
      {
        id: 'seg-26206-132-1',
        ...
        practicalExample:
          'La Res. CFE 85/09 aprobó las orientaciones para la elaboración de acuerdos de convivencia institucional, que todas las escuelas deben tomar como referencia.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-59'],
    jurisprudence: [],
    regulations: [],
    keywords: ['seguridad escolar', 'infraestructura', 'condiciones edilicias', 'evacuación', 'prevención'],
    order: 83,
    segments: [
      {
        id: 'seg-26206-133-1',
        ...
        practicalExample:
          'La autoridad educativa de la provincia clausura preventivamente una escuela primaria cuyo techo presenta grietas estructurales peligrosas y habilita aulas alternativas.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-48', 'art-26206-75'],
    jurisprudence: [],
    regulations: [],
    keywords: ['formación docente continua', 'capacitación', 'postítulo', 'actualización pedagógica'],
    order: 84,
    segments: [
      {
        id: 'seg-26206-134-1',
        ...
        practicalExample:
          'La Dirección de Educación de Mendoza organiza un ciclo de talleres de actualización didáctica para todos los docentes de nivel primario en contraturno, financiado por la provincia.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['profesionalidad docente', 'reconocimiento', 'autonomía pedagógica', 'condiciones de trabajo'],
    order: 85,
    segments: [
      {
        id: 'seg-26206-135-1',
        ...
        practicalExample:
          'Un supervisor que intenta obligar a un docente a seguir un guión didáctico estricto sin permitirle adaptar su clase está violando la autonomía profesional que este artículo reconoce.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La gestión escolar (dirección, vicedirección) es otro camino de carrera con jerarquía propia.',
      'Las provincias deben diseñar sus estatutos docentes respetando estos dos caminos de carrera.',
    ],
    examples: [
      'Un docente con 25 años de experiencia y múltiples postítulos puede ascender a la categoría de Docente Principal sin abandonar el aula y percibir un salario equivalente al de un directivo.',
    ],
    relatedArticles: ['art-26206-49', 'art-26206-96'],
    jurisprudence: [],
    regulations: [],
    keywords: ['carrera docente', 'enseñanza', 'gestión educativa', 'jerarquización', 'desarrollo profesional'],
    order: 86,
    segments: [
      {
        id: 'seg-26206-136-1',
        ...
        practicalExample:
          'La provincia de Santa Fe crea la figura del Docente Experto que puede ascender en categoría salarial sin convertirse en directivo, reconociendo la trayectoria en el aula.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las designaciones provisionales (suplencias, interinatos) son previas al concurso y temporarias.',
      'El concurso debe ser público: cualquier docente habilitado puede presentarse.',
    ],
    examples: [
      'Una provincia convoca a concurso para cubrir 50 cargos de docente de matemáticas en nivel secundario: los postulantes presentan antecedentes y dan una clase de prueba ante un jurado.',
    ],
    relatedArticles: ['art-26206-49', 'art-26206-136'],
    jurisprudence: [],
    regulations: [],
    keywords: ['concurso docente', 'oposición', 'antecedentes', 'ingreso', 'mérito'],
    order: 87,
    segments: [
      {
        id: 'seg-26206-137-1',
        ...
        practicalExample:
          'Un docente que ganó el concurso tiene estabilidad en el cargo y no puede ser removido sin causa; uno que está de interino puede perder el cargo si un titular concursa.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La estabilidad protege la libertad pedagógica del docente ante presiones de directivos o funcionarios.',
      'El cambio de autoridades políticas no puede implicar la remoción de docentes titulares.',
    ],
    examples: [
      'Un docente que critica públicamente la política educativa provincial no puede ser removido de su cargo por esa razón: la estabilidad lo protege de represalias.',
    ],
    relatedArticles: ['art-26206-49', 'art-26206-137'],
    jurisprudence: [],
    regulations: [],
    keywords: ['estabilidad docente', 'titular', 'sumario', 'remoción', 'art. 14 bis CN'],
    order: 88,
    segments: [
      {
        id: 'seg-26206-138-1',
        ...
        practicalExample:
          'Un docente titular es acusado de irregularidades y la provincia inicia un sumario administrativo; hasta que el sumario no concluya con sanción firme, el docente mantiene su cargo.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-49'],
    jurisprudence: [],
    regulations: [],
    keywords: ['licencias docentes', 'maternidad', 'paternidad', 'enfermedad', 'capacitación'],
    order: 89,
    segments: [
      {
        id: 'seg-26206-139-1',
        ...
        practicalExample:
          'Un docente que cursa un postítulo presencial puede solicitar una licencia por capacitación para asistir a los talleres intensivos sin perder el salario.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-49'],
    jurisprudence: [],
    regulations: ['Ley 24.016 (Jubilación docente nacional)'],
    keywords: ['jubilación docente', 'privilegio', 'retiro', 'ANSES', 'previsión social'],
    order: 90,
    segments: [
      {
        id: 'seg-26206-140-1',
        ...
        practicalExample:
          'Un maestro de 57 años con 30 de servicio docente puede jubilarse con el régimen de privilegio docente de la Ley 24.016, accediendo antes que con el régimen general.',
        references: ['Ley 24.016'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas en zonas con alta incidencia de trabajo infantil deben tener dispositivos especiales de inclusión.',
      'La erradicación del trabajo infantil requiere coordinación con el Ministerio de Trabajo y los organismos de niñez.',
    ],
    examples: [
      'En Mendoza, el programa de escuelas con extensión horaria en zonas de cosecha permite que los hijos de trabajadores rurales accedan a la educación mientras sus padres trabajan estacionalmente.',
    ],
    relatedArticles: ['art-26206-79', 'art-26206-80'],
    jurisprudence: [],
    regulations: ['Ley 26.061 de Protección Integral de NNA'],
    keywords: ['trabajo infantil', 'erradicación', 'inclusión', 'niños trabajadores', 'educación'],
    order: 91,
    segments: [
      {
        id: 'seg-26206-141-1',
        ...
        practicalExample:
          'Una escuela en zona de cosecha de Río Negro implementa turnos especiales durante la temporada para que los hijos de trabajadores rurales migrantes puedan asistir a clase.',
        references: ['Ley 26.061'],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26206-108'],
    jurisprudence: [],
    regulations: [],
    keywords: ['catástrofe', 'desastre natural', 'continuidad educativa', 'emergencia', 'alternativas'],
    order: 92,
    segments: [
      {
        id: 'seg-26206-142-1',
        ...
        practicalExample:
          'Tras la erupción del volcán Copahue, las escuelas neuquinas afectadas son evacuadas y el ministerio organiza aulas provisorias en comunidades cercanas mientras se restauran los edificios.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Las escuelas deben ser espacios de ejercicio democrático (elecciones estudiantiles, debates, asambleas).',
      'El currículo debe incluir el conocimiento de las instituciones democráticas y los derechos fundamentales.',
    ],
    examples: [
      'En Formación Ética y Ciudadana de 4to año, los alumnos simulan un debate parlamentario para votar una ley sobre medio ambiente, ejercitando las formas democráticas de toma de decisión.',
    ],
    relatedArticles: ['art-26206-11', 'art-26206-71'],
    jurisprudence: [],
    regulations: [],
    keywords: ['ciudadanía', 'democracia', 'formación ciudadana', 'participación', 'derechos cívicos'],
    order: 93,
    segments: [
      {
        id: 'seg-26206-143-1',
        ...
        practicalExample:
          'La Jornada de Reflexión sobre el golpe de Estado de 1976, realizada el 24 de marzo en todas las escuelas del país, es una práctica concreta de formación ciudadana democrática.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El Defensor puede investigar y emitir recomendaciones a los organismos estatales.',
      'La actuación del Defensor no reemplaza la vía judicial pero es más accesible para los ciudadanos.',
    ],
    examples: [
      'Una familia que no consigue vacante para su hijo en una escuela pública puede presentar una queja ante la Defensoría del Pueblo, que investiga si el Estado está cumpliendo su obligación de garantizar el acceso.',
    ],
    relatedArticles: ['art-26206-2', 'art-26206-4'],
    jurisprudence: [],
    regulations: ['Ley 24.284 del Defensor del Pueblo de la Nación'],
    keywords: ['Defensor del Pueblo', 'ombudsman', 'quejas', 'derechos educativos', 'control ciudadano'],
    order: 94,
    segments: [
      {
        id: 'seg-26206-144-1',
        ...
        practicalExample:
          'La Defensoría del Pueblo investiga una denuncia masiva sobre la falta de docentes en escuelas rurales de Chaco y emite una recomendación al Ministerio de Educación provincial para cubrir los cargos vacantes.',
        references: ['Ley 24.284'],
        order: 1,
      },
    ],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      ...
      'La ley fue publicada en el Boletín Oficial el 28 de diciembre de 2006.',
      'Desde el 29 de diciembre de 2006, la Ley 26.206 está en vigor en todo el territorio nacional.',
    ],
    examples: [],
    relatedArticles: ['art-26206-115'],
    jurisprudence: [],
    regulations: [],
    keywords: ['comunicación', 'promulgación', 'cláusula de cierre', 'boletín oficial', 'vigencia'],
    order: 95,
    segments: [
      {
        id: 'seg-26206-145-1',
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Vincula la educación al desarrollo económico, la democracia y los derechos humanos.',
    ],
    examples: [
      'Los cambios de gobierno no pueden desmantelar el sistema educativo construido bajo esta ley.',
    ],
    relatedArticles: ['art-26206-2', 'art-26206-4'],
    jurisprudence: [],
    regulations: [],
    keywords: ['política de Estado', 'prioridad nacional', 'democracia', 'soberanía', 'desarrollo'],
    order: 10,
    segments: [
      {
        id: 'seg-26206-3-1',
