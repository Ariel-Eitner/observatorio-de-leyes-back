...
export const ARTICLES_10: Article[] = [
	{
		...
		currentText:
			'Las disputas entre Estado y VPU se resuelven: primero por negociación amigable (60 días); luego por arbitraje internacional a elección del VPU: CPA, CCI o CIADI. El arbitraje es fuera de Argentina; 3 árbitros sin nacionalidad argentina ni del accionista mayoritario; en español.',
	...
	},
	{
		...
		currentText:
			'Los derechos del RIGI son "inversiones protegidas" bajo los Tratados Bilaterales de Inversión (TBI) que Argentina tiene vigentes con otros países. Si el Estado viola esos derechos, puede generar responsabilidad internacional.',
		plainLanguageExplanation:
	...
	},
	{
		...
		currentText:
			'El inicio de un arbitraje no suspende ni altera los derechos del VPU ni las obligaciones del Estado bajo el RIGI. El proyecto sigue operando con todos sus beneficios mientras dura el proceso arbitral.',
		plainLanguageExplanation:
