...
export const SECTION_01: LawSection = {
	...
	lawId: 'ley-27742',
	number: 'I',
	name: 'Creación y ámbito de aplicación',
	articleStart: 164,
	articleEnd: 166,
	titles: [],
};
...
export const ARTICLES_01: Article[] = [
	{
		...
		practicalEffects: [
			'Da nacimiento legal al RIGI como régimen promocional de aplicación nacional',
			'El RIGI se aplica exclusivamente a "vehículos de proyecto único" (VPU), es decir, entidades dedicadas a un solo proyecto',
			'El Poder Ejecutivo tiene atribuciones para reglamentarlo (lo hizo mediante Decreto 749/2024)',
		],
		examples: [
			'Una empresa que crea una sociedad anónima dedicada exclusivamente a un proyecto de litio en Jujuy puede adherir al RIGI bajo esta norma',
		],
		relatedArticles: ['rigi-art-165', 'rigi-art-166', 'rigi-art-167', 'rigi-art-169'],
		jurisprudence: [],
		regulations: ['Decreto 749/2024 — Reglamentación del RIGI, Art. 1°'],
		keywords: ['RIGI', 'creación', 'régimen especial', 'grandes inversiones', 'vehículo de proyecto único'],
		order: 164,
		segments: [],
		amendments: [],
	},
	{
		...
		relatedArticles: ['rigi-art-164', 'rigi-art-200', 'rigi-art-201', 'rigi-art-202'],
		jurisprudence: [],
		regulations: [],
		keywords: ['interés nacional', 'nulidad', 'intangibilidad', 'provincias', 'bloqueo normativo'],
		order: 165,
		segments: [],
		amendments: [],
	},
	{
		...
		practicalEffects: [
			'Los objetivos se usan para interpretar el régimen: casos dudosos deben resolverse priorizando la atracción de inversión',
			'La Autoridad de Aplicación debe evaluar las solicitudes considerando estos objetivos',
			'Los críticos señalan que los objetivos son genéricos y podrían justificar beneficios para cualquier actividad "competitiva"',
		],
		examples: [],
		relatedArticles: ['rigi-art-164', 'rigi-art-165', 'rigi-art-167'],
		jurisprudence: [],
		regulations: ['Decreto 749/2024 — Reglamentación de los arts. 164 a 166'],
		keywords: ['objetivos RIGI', 'inversión extranjera', 'exportaciones', 'empleo', 'previsibilidad'],
		order: 166,
		segments: [],
		amendments: [],
	},
