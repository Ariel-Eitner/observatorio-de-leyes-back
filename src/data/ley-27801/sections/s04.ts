...
// Capítulo X — Normas especiales para la competencia nacional ordinaria y federal (arts. 37-47)
// Capítulo XI — Disposiciones finales (arts. 48-53)

export const ARTICLES_27801_04: Article[] = [
  {
    id: 'art-27801-37',
    lawId: 'ley-27801',
    number: '37',
    ...
    relatedArticles: ['art-27801-5'],
    jurisprudence: [],
    regulations: [],
    keywords: ['plazo razonable', 'falta grave', 'dilación', 'Consejo de la Magistratura', 'Procuración General', 'sanción disciplinaria'],
    order: 37,
    segments: [],
    amendments: [],
  },
  {
    ...
    examples: [],
    relatedArticles: ['art-27801-27', 'art-27801-28'],
    jurisprudence: [],
    regulations: ['Convención sobre los Derechos del Niño — marco internacional del proceso penal juvenil'],
    keywords: ['especialización', 'jueces', 'fiscales', 'defensores', 'selección', 'Convención sobre los Derechos del Niño'],
    order: 38,
    segments: [],
    amendments: [],
  },
  {
    ...
    jurisprudence: [],
    regulations: [
      'Código Procesal Penal Federal — ley 27.063: (art. 17 CPP): peligro de fuga y obstaculización como únicos fundamentos',
      'Ley 24.390 modificada por ley 25.430 — plazo máximo de prisión preventiva',
    ],
    keywords: ['medidas de coerción', 'prisión preventiva', 'peligro de fuga', 'obstaculización', 'plazo máximo'],
    order: 39,
    segments: [],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-27801-6', 'art-27801-7', 'art-27801-42'],
    jurisprudence: [],
    regulations: ['Ley de Derechos y Garantías de las Personas Víctimas de Delitos N° 27.372 — derechos generales de las víctimas'],
    keywords: ['derechos de las víctimas', 'asistencia especializada', 'patrocinio gratuito', 'mediación', 'Ministerio de Justicia'],
    order: 40,
    segments: [],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-27801-42', 'art-27801-43', 'art-27801-40'],
    jurisprudence: [],
    regulations: ['Ley de Derechos y Garantías de las Personas Víctimas de Delitos N° 27.372 — intervención de la víctima en el criterio de oportunidad'],
    keywords: ['criterio de oportunidad', 'acción penal', 'prescindencia', 'seis años', 'oposición de la víctima', 'fiscal superior'],
    order: 41,
    segments: [],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-27801-41', 'art-27801-43', 'art-27801-22'],
    jurisprudence: [],
    regulations: [],
    keywords: ['mediación penal juvenil', 'confidencial', 'voluntario', 'consentimiento de la víctima', 'oposición del fiscal', 'seis años'],
    order: 42,
    segments: [],
    amendments: [],
  },
  {
    ...
    relatedArticles: ['art-27801-41', 'art-27801-42', 'art-27801-44', 'art-27801-45'],
    jurisprudence: [],
    regulations: [],
    keywords: ['suspensión del proceso a prueba', 'probation', 'mínimo de pena', 'tres años', 'reparación del daño', 'audiencia oral'],
    order: 43,
    segments: [],
    amendments: [],
  },
  {
    ...
    examples: [],
    relatedArticles: ['art-27801-8', 'art-27801-42', 'art-27801-43'],
    jurisprudence: [],
    regulations: [],
    keywords: ['condiciones de cumplimiento', 'mediación', 'probation', 'medidas complementarias', 'tres años'],
    order: 44,
    segments: [],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      'Cumplimiento total → extinción de la acción penal',
      'Incumplimiento injustificado → el proceso penal se reanuda',
      'El período de incumplimiento no cuenta como tiempo cumplido',
    ],
    examples: [
      'Adolescente en probation que cumple los 2 años de condiciones → la causa se archiva definitivamente',
    ],
    relatedArticles: ['art-27801-43', 'art-27801-44'],
    jurisprudence: [],
    regulations: [],
    keywords: ['extinción acción penal', 'incumplimiento', 'plazos', 'continuación del proceso'],
    order: 45,
    segments: [],
    amendments: [],
  },
  {
    ...
    examples: [],
    relatedArticles: ['art-27801-23'],
    jurisprudence: [],
    regulations: [],
    keywords: ['supervisor', 'Ministerio de Justicia', 'lista oficial', 'especialidades', 'designación'],
    order: 46,
    segments: [],
    amendments: [],
  },
  {
    ...
    jurisprudence: [],
    regulations: [
      'Código Procesal Penal Federal — ley 27.063: sistema acusatorio',
      'Ley 27.150 — régimen de implementación progresiva del CPPF',
    ],
    keywords: ['CPPF', 'sistema acusatorio', 'principios', 'ley 27.063', 'ley 27.150'],
    order: 47,
    segments: [],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      'La ley 22.278 (régimen de facto) queda completamente derogada',
      'Esta ley la reemplaza íntegramente a partir de su entrada en vigencia',
    ],
    examples: [],
    relatedArticles: ['art-27801-52'],
    jurisprudence: [],
    regulations: [],
    keywords: ['derogación', 'ley 22.278', 'régimen penal de la minoridad'],
    order: 48,
    segments: [],
    amendments: [],
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['provincias', 'CABA', 'adecuación', 'legislación procesal', 'autonomía provincial'],
    order: 49,
    segments: [],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      'La autoridad de aplicación la determina el Ejecutivo nacional',
      'El objetivo explícito es reducir la reincidencia delictual con intervenciones basadas en evidencia',
    ],
    examples: [],
    relatedArticles: [],
    jurisprudence: [],
    regulations: [],
    keywords: ['control de implementación', 'Poder Ejecutivo', 'autoridad de aplicación', 'reincidencia'],
    order: 50,
    segments: [],
    amendments: [],
  },
  {
    ...
    jurisprudence: [],
    regulations: [],
    keywords: ['presupuesto', 'asignación presupuestaria', 'Ministerio de Justicia', 'Defensoría General', 'convenios'],
    order: 51,
    segments: [],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      'Publicación en BO: 9 de marzo de 2026',
      'Entrada en vigencia: 5 de septiembre de 2026',
      'Durante los 180 días, sigue vigente la ley 22.278',
    ],
    examples: [],
    relatedArticles: ['art-27801-48'],
    jurisprudence: [],
    regulations: [],
    keywords: ['vigencia', '180 días', 'Boletín Oficial', 'entrada en vigor'],
    order: 52,
    segments: [],
    amendments: [],
  },
  {
    ...
    practicalEffects: [
      'Fórmula de promulgación — sin contenido normativo sustantivo',
    ],
    examples: [],
    relatedArticles: [],
    jurisprudence: [],
    regulations: [],
    keywords: ['comunicación', 'Poder Ejecutivo', 'promulgación'],
    order: 53,
    segments: [],
    amendments: [],
  },
