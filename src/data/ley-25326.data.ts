...
export const LEY_25326: Law = {
  ...
  articles: [
      ...
      segments: [
        {
          ...
          practicalExample: 'Una empresa de informes crediticios que carga una deuda ficticia en el perfil de un usuario, sabiendo que es falsa, comete el Art. 117 bis. Si además emite ese informe negativo a un banco, comete también el inciso 2.',
    ...
    },
    {
      ...
      relatedArticles: ['art-25326-32'],
      jurisprudence: [],
      regulations: ['Art. 117 bis del Código Penal (incorporado por esta ley)'],
    ...
    },
    {
      ...
      jurisprudence: [],
      regulations: ['Art. 157 bis del Código Penal (incorporado por esta ley)'],
