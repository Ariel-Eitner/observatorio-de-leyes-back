...
export const ARTICLES_26639_02: Article[] = [
  {
    id: 'art-26639-6',
    lawId: 'ley-26639',
    number: '6',
    ...
    examples: [
      ...
      'Pascua-Lama fue suspendida en la parte argentina porque el proyecto implicaba remoción de glaciares de escombros (inciso c)',
      'Una empresa de esquí que quiere instalar un telesilla en zona periglacial debe evitar la prohibición de infraestructura — aunque podría argumentar que no afecta la condición natural',
      'Un campamento científico con carpas y sin residuos dejados está exento: entra en la excepción de investigación científica del inciso b)',
    ],
    relatedArticles: ['art-26639-1', 'art-26639-2', 'art-26639-7', 'art-26639-11'],
    jurisprudence: [
      'Juzgado Federal de San Juan — Derrames en Veladero (2016): se aplicó el inciso a) para ordenar medidas de remediación y restricciones a la mina',
      'Cámara Federal de Apelaciones de Mendoza — Pascua-Lama: confirmó la suspensión de actividades por violación del inciso c)',
      'CSJN — Barrick Exploraciones Argentinas c/ Estado Nacional (2019): rechazó el planteo de inconstitucionalidad de este artículo',
    ],
    regulations: ['Decreto 207/2011 (art. 6: sin reglamentar — operativo por sí mismo)'],
    keywords: ['actividades prohibidas', 'minería', 'contaminación', 'infraestructura', 'industria', 'periglacial', 'Barrick', 'Veladero'],
    order: 6,
    segments: [
      {
        id: 'seg-26639-6-0',
        ...
        practicalExample:
          'El derrame de solución cianurada de Veladero en 2015 (un caño roto liberó 15 millones de litros de agua con cianuro cerca de un glaciar de escombros) fue el caso paradigmático de este inciso.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Pascua-Lama (San Juan) pretendía remover tres glaciares de escombros para acceder al mineral. Eso viola tanto el inciso c) como el espíritu del art. 1 (destrucción del glaciar).',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un equipo del IANIGLA que toma muestras de hielo a pie está exento del EIA (inciso b)',
      'Un rescatista de montaña en emergencia no necesita ningún trámite previo (inciso a)',
      'Un rally o competencia de motos en zona de montaña que atraviese zona periglacial viola este artículo porque los deportes motorizados no están exentos',
    ],
    relatedArticles: ['art-26639-6', 'art-26639-8'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 7: define Evaluación Ambiental Estratégica como proceso sistemático de estudio de impactos de políticas, planes o programas)'],
    keywords: ['evaluación de impacto ambiental', 'EIA', 'participación ciudadana', 'deportes', 'científica', 'rescate', 'turismo'],
    order: 7,
    segments: [
      {
        id: 'seg-26639-7-0',
        ...
        practicalExample:
          'Un emprendimiento de turismo aventura con campamentos fijos en zona periglacial no está prohibido por el art. 6, pero sí requiere EIA y audiencia pública antes de operar. Si lo inicia sin eso, puede ser suspendido.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Un grupo de montañistas que sube el Aconcagua atravesando periglacial no necesita ningún trámite. Pero si el operador instala un campamento base permanente con generadores, sí requeriría EIA.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Los glaciares en parques nacionales (como el Perito Moreno en el Parque Nacional Los Glaciares) están bajo APN',
      'La falta de determinación del organismo provincial puede generar vacíos de fiscalización',
    ],
    examples: [
      'El glaciar Perito Moreno está en el Parque Nacional Los Glaciares → APN es la autoridad competente, no la provincia de Santa Cruz',
      'Los glaciares de la cordillera sanjuanina fuera de parques nacionales → la autoridad provincial de San Juan (Secretaría de Minería o Ambiente) es la competente',
    ],
    relatedArticles: ['art-26639-9', 'art-26639-10'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 8: sin reglamentar)'],
    keywords: ['autoridad competente', 'jurisdicción', 'parques nacionales', 'APN', 'Ley 22351'],
    order: 8,
    segments: [
      {
        id: 'seg-26639-8-0',
        ...
        practicalExample:
          'El glaciar Perito Moreno está en el Parque Nacional Los Glaciares (Ley 22.351). La APN es la autoridad competente, no la Provincia de Santa Cruz. Si hubiera alguna actividad en sus márgenes, sería APN quien debe controlar.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El decreto 207/2011 designó formalmente a la Secretaría de Ambiente de la Jefatura de Gabinete',
      'El organismo nacional coordina con las autoridades provinciales del art. 8',
    ],
    examples: [
      'En el gobierno de Milei (2024), el organismo de mayor nivel ambiental fue la Secretaría de Ambiente, dependiente de la Presidencia',
      'En el gobierno de Alberto Fernández (2019-2023), fue el Ministerio de Ambiente y Desarrollo Sostenible con rango de ministerio',
    ],
    relatedArticles: ['art-26639-8', 'art-26639-10'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 9): designa a la Secretaría de Ambiente y Desarrollo Sustentable como Autoridad de Aplicación'],
    keywords: ['autoridad de aplicación', 'organismo nacional', 'secretaría de ambiente', 'ministerio'],
    order: 9,
    segments: [
      {
        id: 'seg-26639-9-0',
        ...
        practicalExample:
          'Con Alberto Fernández fue el Ministerio de Ambiente y Desarrollo Sostenible. Con Milei, que eliminó ese ministerio, pasó a ser la Secretaría de Ambiente dependiente de la Presidencia. El artículo no exige una estructura fija sino que sea el máximo organismo ambiental del momento.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El inciso h) conecta el inventario con los compromisos internacionales de cambio climático (CMNUCC)',
      'El COFEMA (Consejo Federal de Medio Ambiente) es el espacio de coordinación nacional-provincial',
    ],
    examples: [
      'La Secretaría de Ambiente debe presentar ante el Congreso un informe cuando se detectan actividades en zonas de influencia glaciar',
      'Los resultados del inventario van a los informes que Argentina presenta en las COP de cambio climático',
    ],
    relatedArticles: ['art-26639-5', 'art-26639-8', 'art-26639-9'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 10: sin reglamentar)'],
    keywords: ['funciones', 'autoridad nacional', 'COFEMA', 'cambio climático', 'inventario', 'informe al Congreso', 'CMNUCC'],
    order: 10,
    segments: [
      {
        id: 'seg-26639-10-0',
        ...
        practicalExample:
          'Cuando la provincia de San Juan quiso flexibilizar la aplicación de la ley para la mina Veladero, el COFEMA fue el espacio donde se discutió el conflicto entre la interpretación provincial y la nacional.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Si la Secretaría de Ambiente no envía estos informes al Congreso, los diputados pueden interpelar al ministro o secretario responsable y exigirlos. Organizaciones ambientales como la Fundación Ambiente y Recursos Naturales (FARN) han monitoreado el cumplimiento de esta obligación.',
        references: [],
        order: 1,
      },
    ],
