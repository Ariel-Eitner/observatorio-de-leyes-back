...
export const ARTICLES_26639_01: Article[] = [
  {
    id: 'art-26639-1',
    lawId: 'ley-26639',
    number: '1',
    ...
    practicalEffects: [
      ...
      'Establece un piso de protección nacional: las provincias no pueden legislar por debajo',
      'Protege tanto glaciares como ambiente periglacial (la zona de suelos congelados que los rodea)',
      'Reconoce el valor múltiple: agua, biodiversidad, ciencia y turismo',
    ],
    examples: [
      'Una empresa minera no puede argumentar que el terreno en superficie es su propiedad para operar sobre el glaciar — el glaciar es público independientemente del terreno',
      'La provincia de San Juan no puede dictar una ley que permita actividades que esta ley prohíbe en glaciares',
      'Un municipio puede dictar normas más restrictivas sobre uso de zonas glaciares, pero nunca más permisivas que esta ley',
    ],
    relatedArticles: ['art-26639-2', 'art-26639-6'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 1: sin reglamentar — operativo por sí mismo)'],
    keywords: ['presupuestos mínimos', 'bienes públicos', 'reservas estratégicas', 'recursos hídricos', 'objeto'],
    order: 1,
    segments: [
      {
        id: 'seg-26639-1-0',
        ...
        practicalExample:
          'Si Mendoza aprobara una ley permitiendo minería en glaciares, sería inconstitucional porque viola el piso fijado por esta norma nacional.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Barrick Gold argumentó que sus concesiones mineras le daban derechos sobre el terreno. La Corte Suprema sostuvo que el glaciar en sí es un bien público que no puede ser afectado por esas concesiones.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Un pequeño glaciar de 2 hectáreas tiene la misma protección legal que el Perito Moreno',
      'Un depósito de detritos rocosos asociado a un glaciar está protegido junto con el glaciar mismo',
    ],
    relatedArticles: ['art-26639-1', 'art-26639-6'],
    jurisprudence: [
      'El debate técnico sobre qué es "ambiente periglacial" fue central en los casos de Barrick Gold y en la validez del Inventario Nacional de Glaciares del IANIGLA',
    ],
    regulations: ['Decreto 207/2011 (art. 2: sin reglamentar)'],
    keywords: ['glaciar', 'ambiente periglacial', 'definición', 'hielo perenne', 'suelos congelados', 'permafrost'],
    order: 2,
    segments: [
      {
        id: 'seg-26639-2-0',
        ...
        practicalExample:
          'Un "glaciar de escombros" (roca con hielo interno) que no parece un glaciar clásico a simple vista igual entra en la definición y está protegido.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'La zona donde opera Veladero (Barrick Gold) en San Juan fue identificada por el IANIGLA como ambiente periglacial. Por eso los jueces aplicaron la ley aun cuando no había glaciares típicos en el área operativa directa.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'En 2018, el inventario identificó 8.400 km² de superficie glaciar en Argentina — el tercero más grande de América del Sur',
    ],
    relatedArticles: ['art-26639-4', 'art-26639-5'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 3: sin reglamentar)'],
    keywords: ['inventario nacional', 'glaciares', 'geoformas periglaciales', 'monitoreo', 'reservas hídricas'],
    order: 3,
    segments: [
      {
        id: 'seg-26639-3-0',
        ...
        practicalExample:
          'El IANIGLA completó el primer Inventario Nacional de Glaciares en 2018 e identificó más de 16.000 cuerpos de hielo. A partir de ese inventario, las autoridades pueden verificar si una actividad nueva está en zona registrada como glaciar o periglacial.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    relatedArticles: ['art-26639-3', 'art-26639-5'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (arts. 4 y 5: define metodología de inventario en tres niveles y cinco regiones geográficas)'],
    keywords: ['inventario', 'cuenca hidrográfica', 'superficie', 'clasificación morfológica', 'actualización', 'cinco años'],
    order: 4,
    segments: [
      {
        id: 'seg-26639-4-0',
        ...
        practicalExample:
          'Gracias a que el inventario organiza por cuenca, se puede saber exactamente qué glaciares alimentan al río San Juan y cuáles serían afectados si una mina opera en la cuenca alta.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Si el inventario de 2018 muestra que el glaciar X mide 100 ha y el de 2023 muestra 80 ha, y en ese período se instaló una mina cercana, ese retroceso es evidencia usable en juicio para imputar daño ambiental.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'En zonas como la frontera argentino-chilena en San Juan, la Cancillería tuvo que dar su aval antes de que el IANIGLA registrara los cuerpos de hielo',
    ],
    relatedArticles: ['art-26639-3', 'art-26639-4', 'art-26639-10'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (arts. 4 y 5: define metodología en tres niveles escalonados y cinco regiones cordilleranas)'],
    keywords: ['IANIGLA', 'inventario', 'monitoreo', 'responsabilidad', 'zonas fronterizas', 'Cancillería'],
    order: 5,
    segments: [
      {
        id: 'seg-26639-5-0',
        ...
        practicalExample:
          'Cuando la empresa Barrick Gold intentó cuestionar que ciertas geoformas eran "glaciares de escombros" y debían estar en el inventario, fue el IANIGLA —no el gobierno— quien definió técnicamente la cuestión con autoridad científica independiente.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'En la frontera argentino-chilena en San Juan y Mendoza — donde se encuentran Pascua-Lama y otros proyectos binacionales — algunos cuerpos de hielo están en zonas cuyo límite aún se discute. El IANIGLA no puede registrarlos unilateralmente sin aval de Cancillería.',
        references: [],
        order: 1,
      },
    ],
