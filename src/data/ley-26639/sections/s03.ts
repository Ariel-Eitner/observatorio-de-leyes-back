...
export const ARTICLES_26639_03: Article[] = [
  {
    id: 'art-26639-11',
    lawId: 'ley-26639',
    number: '11',
    ...
    practicalEffects: [
      ...
      'El cese definitivo puede terminar con una concesión minera millonaria sin derecho a indemnización si hay incumplimiento',
      'Las provincias que no tengan su propio régimen usan estas sanciones nacionales de manera supletoria',
      'La expresión en "sueldos básicos" actualiza automáticamente las multas con los aumentos salariales del Estado',
    ],
    examples: [
      'Barrick Gold recibió multas por los derrames de Veladero — la provincia de San Juan aplicó su régimen propio, pero con piso en estas sanciones nacionales',
      'Una mina que continúa operando después de una orden de suspensión puede recibir el cese definitivo de la actividad',
      'Si la provincia no tiene norma propia, aplica directamente este artículo como supletorio',
    ],
    relatedArticles: ['art-26639-6', 'art-26639-12', 'art-26639-13', 'art-26639-14'],
    jurisprudence: [
      'Juzgado Federal de San Juan — aplicó el esquema sancionatorio de este artículo como base para las medidas sobre Veladero (2016-2018)',
    ],
    regulations: ['Decreto 207/2011 (art. 11: sin reglamentar)'],
    keywords: ['sanciones', 'multa', 'cese', 'suspensión', 'apercibimiento', 'infracciones', 'sueldos básicos'],
    order: 11,
    segments: [
      {
        id: 'seg-26639-11-0',
        ...
        practicalExample:
          'Si el sueldo básico inicial del Estado es $180.000, la multa mínima es $18.000.000 y la máxima $18.000.000.000. Barrick Gold, empresa de miles de millones de dólares, podría ver eso como menor si el impacto económico de detener la mina es mayor.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Una empresa que fue multada por contaminación de ríos en 2022 y después viola la ley de glaciares en 2025 es reincidente',
    ],
    relatedArticles: ['art-26639-11', 'art-26639-13'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 12: sin reglamentar)'],
    keywords: ['reincidencia', 'triplicar', 'cinco años', 'antecedentes ambientales', 'sanción agravada'],
    order: 12,
    segments: [
      {
        id: 'seg-26639-12-0',
        ...
        practicalExample:
          'Barrick Gold fue sancionada por el derrame de Veladero en 2015. Si antes de 2020 hubiera un nuevo incumplimiento, la empresa ya sería reincidente y las multas podrían triplicarse. Dado que en 2016 y 2017 hubo nuevos derrames, ese historial fue considerado en las sanciones agravadas.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'Elimina el "escudo corporativo" ante violaciones ambientales graves',
      'Desincentiva que los directivos ordenen actividades prohibidas esperando que solo la empresa pague',
    ],
    examples: [
      'Si el directorio de una minera aprueba un proyecto en zona periglacial, los directores son solidariamente responsables de las sanciones',
      'El CEO que firma la autorización de una operación en zona glaciar puede ser sancionado personalmente junto con la empresa',
    ],
    relatedArticles: ['art-26639-11', 'art-26639-12'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 13: sin reglamentar)'],
    keywords: ['responsabilidad solidaria', 'persona jurídica', 'directivos', 'gerentes', 'administración'],
    order: 13,
    segments: [
      {
        id: 'seg-26639-13-0',
        ...
        practicalExample:
          'Si el directorio de una minera aprueba avanzar con un proyecto en zona periglacial sabiendo que está prohibido, cada miembro del directorio que votó a favor puede ser sancionado personalmente junto con la empresa. Esto desincentiva la decisión de "arriesgamos la multa y seguimos".',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La "prioridad" de afectación no es exclusiva: el sobrante puede ir a rentas generales',
      'En la práctica, el cumplimiento de esta afectación específica ha sido irregular',
    ],
    examples: [
      'La multa de Barrick Gold por el derrame de Veladero en San Juan debería haber financiado tareas de remediación del área afectada',
    ],
    relatedArticles: ['art-26639-11'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 14: sin reglamentar)'],
    keywords: ['destino', 'multas', 'restauración', 'protección', 'afectación específica', 'contaminador-pagador'],
    order: 14,
    segments: [
      {
        id: 'seg-26639-14-0',
        ...
        practicalExample:
          'La multa que la provincia de San Juan cobró a Barrick Gold por el derrame de Veladero debería haber financiado la remediación de la zona periglacial afectada. Organizaciones ambientales cuestionaron si ese destino específico fue efectivamente respetado.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      'Veladero, activo desde 2005, también fue sometido a la auditoría; los resultados y los posteriores derrames condujeron a las sanciones de 2016',
    ],
    relatedArticles: ['art-26639-3', 'art-26639-6'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 15: sin reglamentar)'],
    keywords: ['disposición transitoria', '180 días', 'auditoría ambiental', 'actividades en ejecución', 'Pascua-Lama', 'Veladero'],
    order: 15,
    segments: [
      {
        id: 'seg-26639-15-0',
        ...
        practicalExample:
          'Cuando la ley se sancionó en octubre de 2010, la zona de Pascua-Lama y Veladero (San Juan) fue inmediatamente identificada como prioritaria. El IANIGLA debía tener inventariadas esas geoformas periglaciales en 180 días — lo que sentó las bases del conflicto judicial posterior.',
        references: [],
        order: 0,
      },
      {
        ...
        practicalExample:
          'Pascua-Lama, activa desde 2009 en la parte argentina, tuvo que hacer esa auditoría. Los resultados —combinados con los derrames posteriores de Veladero— alimentaron los juicios que terminaron en la suspensión de Pascua-Lama en 2013 y en sanciones millonarias a Barrick.',
        references: [],
        order: 1,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'La ley de glaciares aplica en la Antártida argentina pero sin contradicción con los tratados internacionales',
      'Tiene relevancia principalmente para actividades científicas en la Antártida',
    ],
    examples: [
      'Las bases antárticas argentinas (Marambio, Esperanza, etc.) que se encuentran en zonas glaciares están regidas por el Protocolo de Madrid principalmente, y esta ley en segundo plano',
    ],
    relatedArticles: ['art-26639-1', 'art-26639-5'],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (art. 16: sin reglamentar)'],
    keywords: ['Antártida', 'Sector Antártico', 'Tratado Antártico', 'Protocolo de Madrid', 'derecho internacional'],
    order: 16,
    segments: [
      {
        id: 'seg-26639-16-0',
        ...
        practicalExample:
          'Las bases científicas argentinas en la Antártida (Marambio, Esperanza, etc.) que están en zonas glaciares aplican el Protocolo de Madrid primero y esta ley en segundo plano. Si un país quisiera hacer minería antártica (lo que está prohibido hasta 2048), ni el Protocolo ni esta ley lo permitirían.',
        references: [],
        order: 0,
      },
    ],
  ...
  },
  {
    ...
    practicalEffects: [
      ...
      'El decreto concluyó que la ley es operativa sin necesidad de reglamentación detallada',
      'Solo los arts. 4, 5 y 7 requirieron clarificación técnica en el decreto',
    ],
    examples: [],
    relatedArticles: [],
    jurisprudence: [],
    regulations: ['Decreto 207/2011 (reglamentación dictada en cumplimiento de este artículo)'],
    keywords: ['reglamentación', '90 días', 'Boletín Oficial', 'Decreto 207/2011'],
    order: 17,
    segments: [
      {
        id: 'seg-26639-17-0',
        ...
        practicalExample:
          'El Decreto 207/2011 reglamentó la ley pero en la mayoría de los artículos solo dice "sin reglamentar", lo que significa que el artículo se aplica directamente tal como fue redactado por el Congreso. Solo arts. 4, 5 y 7 recibieron clarificación técnica.',
        references: [],
        order: 0,
      },
    ],
