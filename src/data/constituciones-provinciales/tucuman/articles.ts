...
export const ARTICLES_CONST_TUCUMAN: Article[] = [
  {
    ...
    number: '2',
    title: '',
    text: `Las autoridades superiores del gobierno tendrán su sede en la ciudad de San Miguel de Tucumán, que es la capital de la Provincia.`,
  ...
  },
  {
    ...
    number: '4',
    title: '',
    text: `Prestarán juramento de desempeñar fielmente el cargo todos los funcionarios que esta Constitución determine y aquéllos para quienes las leyes lo establezcan. Los funcionarios y empleados públicos serán responsables directamente ante los tribunales de las faltas que cometieren en el ejercicio de sus funciones y de los daños que por ellas causaren. Cuando los culpables sean varios, la responsabilidad es solidaria.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '6',
    title: '',
    text: `Ningún poder de la Provincia podrá suspender la vigencia de las garantías constitucionales.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '10',
    title: '',
    text: `Los extranjeros son admisibles a todos los puestos públicos, con excepción de los casos en que la Constitución exija la ciudadanía o la nacionalidad.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '11',
    title: '',
    text: `Los actos que se refieren a la percepción o inversión de las rentas deben publicarse por lo menos cada mes.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '12',
    title: '',
    text: `Toda enajenación de bienes fiscales y cualquier otro contrato susceptible de licitación, deberá hacerse precisamente en esta forma, salvo el caso en que la Legislatura o la Municipalidad resolviesen lo contrario, por razones especiales reclamadas por el bien público.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '13',
    title: '',
    text: `No se acordará pensiones ni jubilaciones por ley especial ni por la de presupuesto. La Legislatura dictará una ley general estableciendo las condiciones que den derecho a ellas y proveyendo a la formación de un fondo especial para su pago.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '15',
    title: '',
    text: `No se dictarán leyes que importen sentencia o condenación, ni que empeoren la condición de los acusados por hechos anteriores o priven de los derechos adquiridos.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '16',
    title: '',
    text: `La Provincia no podrá negarse a recibir en pago de sus créditos, los títulos con los que ella pague sus deudas.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '18',
    title: '',
    text: `Los fondos públicos que se emitan y el numerario obtenido por el empréstito, no podrán ser aplicados a otros objetos que los determinados por la ley de su creación.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '19',
    title: '',
    text: `Ningún impuesto establecido o aumentado para sufragar la construcción de obras especiales podrá ser aplicado interina o definitivamente, sino a los objetos determinados en la ley de su creación ni durará por más tiempo del que se emplee en redimir la deuda que se contraiga.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '20',
    title: '',
    text: `La Provincia, como persona civil, puede ser demandada ante la Corte Suprema de Justicia provincial sobre propiedad y por obligaciones contraídas, sin necesidad de requisito previo y sin que el juicio deba gozar de privilegio alguno.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '21',
    title: '',
    text: `Toda reclamación de índole administrativa debe ser despachada en el término de tres meses desde el día de su interposición. Vencido ese plazo, el interesado podrá tenerla por denegada y concurrir directamente a la Justicia.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '22',
    title: '',
    text: `Todos los habitantes de la Provincia tienen obligación de concurrir a las cargas públicas en las formas que las leyes establezcan.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '23',
    title: '',
    text: `No se dará en la Provincia ley o reglamento que haga inferior la condición del extranjero a la del ciudadano, ni que obligue a aquéllos a pagar mayores contribuciones que las aportadas por los nacionales o inversamente.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '25',
    title: '',
    text: `No hay derechos irrevocablemente adquiridos contra una ley de orden público.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '26',
    title: '',
    text: `El Gobierno de la Provincia cooperará al sostenimiento del culto Católico, Apostólico, Romano.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '27',
    title: '',
    text: `Es inviolable en el territorio de la Provincia el derecho que todo hombre tiene de rendir culto a Dios, libre y públicamente, según los dictados de su conciencia y con sujeción a lo que prescribe la moral y el orden público.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '28',
    title: '',
    text: `Nadie puede ser perseguido judicialmente más de una vez por el mismo delito, ni bajo pretexto alguno podrán suscitarse nuevos pleitos fenecidos por sentencia ejecutoriada, salvo el caso de revisión.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '29',
    title: '',
    text: `En los juicios la defensa es libre y la prueba pública. Una ley determinará las excepciones fundadas únicamente en el secreto del sumario y en los casos en que la publicidad sea contraria a la moral.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '30',
    title: '',
    text: `Toda sentencia judicial será motivada.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '32',
    title: '',
    text: `El domicilio no puede ser allanado sino por orden escrita y motivada de juez, por delito o falta, y por autoridad sanitaria competente, también escrita y motivada, en el modo y forma que la ley determine por razones de salud pública.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '34',
    title: '',
    text: `Ningún arresto podrá prolongarse más de veinticuatro horas sin dar aviso al juez competente, poniendo al reo a su disposición con los antecedentes del hecho que motive el arresto; desde entonces tampoco podrá el reo permanecer más de tres días incomunicado.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '45',
    title: '',
    text: `Los legisladores durarán cuatro años y podrán ser reelegidos por un nuevo período consecutivo. No podrán ser elegidos nuevamente sino con un intervalo de un período.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '46',
    title: '',
    text: `Para ser Legislador se requiere: 1º) Ciudadanía natural en ejercicio o legal después de dos años de obtenida. 2º) Veinticinco años de edad, como mínimo. 3º) Estar domiciliado en la Provincia en forma ininterrumpida por lo menos dos años antes del acto eleccionario que lo designe.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '49',
    title: '',
    text: `El fallo no tendrá más efecto que el de destituir al acusado y aún declararlo incapaz de ocupar ningún puesto de honor o a sueldo de la Provincia. Ninguna de las personas sujetas a juicio político será declarada culpable sin una mayoría de los dos tercios de la totalidad de los miembros del Tribunal, y de los tres cuartos de la totalidad de los miembros del Tribunal en caso de enjuiciamiento al Gobernador o Vicegobernador. Deberá votarse en todos los casos nominalmente y registrarse en el acta de sesiones el voto de cada Legislador.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '50',
    title: '',
    text: `El que fuese condenado por la Legislatura queda sujeto a acusación y juicio ante los tribunales ordinarios.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '51',
    title: '',
    text: `Corresponde también a la Legislatura, prestar su acuerdo al Poder Ejecutivo para todos aquellos nombramientos en que esta Constitución lo requiera.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '52',
    title: '',
    text: `La Legislatura se reunirá el 1º de marzo de cada año en sesiones ordinarias las que durarán hasta el 30 de junio, inclusive. Volverá a reunirse en un segundo período ordinario de sesiones el 1º de setiembre hasta el 31 de diciembre, inclusive. En el caso de que hasta el 31 de diciembre no se haya dictado la ley de presupuesto para el año siguiente, quedará en vigencia de hecho el presupuesto anterior, hasta que haya el nuevo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '54',
    title: '',
    text: `La Legislatura juzga de las elecciones de sus miembros y de la validez de sus títulos. El rechazo del diploma sólo es recurrible por el interesado ante la Corte Suprema. El trámite se sustanciará por vía sumarísima.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '55',
    title: '',
    text: `La Legislatura necesita la mitad más uno de sus miembros para sesionar; pero un número menor podrá reunirse al efecto de acordar las medidas que estime necesarias para compeler a los inasistentes.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '57',
    title: '',
    text: `La Legislatura podrá hacer venir a sus sesiones a los ministros del Poder Ejecutivo y secretarios del mismo, para pedir los informes que estime convenientes y éstos obligados a darlos, citándolos por lo menos con cinco días de anticipación, salvo caso de urgente gravedad, y siempre comunicándoles, al citarlos, los puntos sobre los cuales hayan de informar.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '58',
    title: '',
    text: `La Legislatura dicta su reglamento. Podrá con dos tercios de votos, corregir a cualquiera de sus miembros, por desorden de conducta en el ejercicio de sus funciones o removerlo por inhabilidad física o moral sobreviniente a su incorporación, y hasta excluirlo de su seno. Bastará la mayoría de uno sobre la mitad de los presentes para decidir en las renuncias que los legisladores hicieran de sus cargos.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '59',
    title: '',
    text: `La Legislatura es presidida por el Vicegobernador, con voto en caso de empate, y tendrá un Presidente Subrogante, y demás autoridades que determine. Es su facultad exclusiva nombrar los empleados que sean necesarios para el cumplimiento de sus funciones, fijar sus remuneraciones en el presupuesto y proveer a las necesidades funcionales del Poder y sectores que integran el Cuerpo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '60',
    title: '',
    text: `Las sesiones son públicas; sólo podrán ser secretas por asuntos graves y previo acuerdo de la mayoría.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '62',
    title: '',
    text: `Los legisladores no serán nunca molestados por los votos que constitucionalmente emitan y opiniones que manifiesten en el desempeño de sus cargos dentro y fuera del recinto legislativo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '68',
    title: '',
    text: `Los legisladores percibirán mensualmente una suma de dinero que se denominará dieta, tendrá carácter compensatorio de la función y será fijada por la Presidencia del Cuerpo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '69',
    title: '',
    text: `Las leyes pueden tener principio por proyectos presentados por los legisladores, por el Vicegobernador o por el Poder Ejecutivo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '70',
    title: '',
    text: `Ningún proyecto de ley rechazado totalmente por la Legislatura, podrá repetirse en las sesiones del mismo año.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '73',
    title: '',
    text: `Si antes del vencimiento de los diez días hubiese tenido lugar la clausura de las sesiones de la Legislatura, el Poder Ejecutivo dentro de dicho término, deberá remitir el proyecto vetado a la Secretaría de la Legislatura, sin cuyo requisito no tendrá efecto el veto.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '75',
    title: '',
    text: `El Poder Ejecutivo, en todos los casos, sólo podrá usar del veto sobre una ley, una sola vez; y si en las sesiones del año siguiente la Legislatura volviese a sancionar la misma ley por mayoría absoluta, el Poder Ejecutivo estará obligado a promulgarla.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '76',
    title: '',
    text: `En la sanción de las leyes se utiliza la siguiente fórmula: La Legislatura de la Provincia de Tucumán, sanciona con fuerza de LEY:`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '83',
    title: '',
    text: `Para ser designado Defensor del Pueblo se deben reunir las mismas condiciones que para ser Legislador, y goza de iguales inmunidades y prerrogativas. Le alcanzan las inhabilidades e incompatibilidades de los jueces.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '84',
    title: '',
    text: `Es designado por la Legislatura por el voto de la mayoría absoluta del total de los miembros en sesión especial y pública convocada al efecto. Su mandato es de cinco años, pudiendo ser designado en forma consecutiva por otro período. Sólo puede ser removido por juicio político.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '85',
    title: '',
    text: `En materia de su competencia tiene legitimación procesal amplia, y su actuación en los procesos en que intervenga estará exenta del pago de cualquier impuesto o tributo, de fianzas o cauciones, y de depósitos como condición de procedibilidad para cualquier trámite o recurso.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '86',
    title: '',
    text: `El Defensor del Pueblo deberá dar cuenta anualmente a la Legislatura de la gestión realizada, en sesión pública especial convocada al efecto. Sección IV Capítulo Primero Del Poder Ejecutivo Su naturaleza y duración`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '87',
    title: '',
    text: `El Poder Ejecutivo de la Provincia será ejercido por un ciudadano con el título de Gobernador. En las mismas elecciones se elegirá un Vicegobernador quien será el reemplazante natural.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '88',
    title: '',
    text: `Para ser elegido Gobernador se requiere ser argentino, tener treinta años de edad, dos de residencia inmediata en la Provincia y de ciudadanía en ejercicio.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '89',
    title: '',
    text: `Iguales requisitos que para Gobernador, serán necesarios para ser elegido Vicegobernador.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '92',
    title: '',
    text: `En caso de acefalía definitiva, no podrán ser elegidos como Gobernador o Vicegobernador quienes al momento de la convocatoria se desempeñaren como Gobernador provisorio, ministros o miembros del gabinete, si no cesaren en sus cargos al día siguiente de la misma.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '93',
    title: '',
    text: `La convocatoria a elecciones para completar período deberá ser hecha por el ciudadano que desempeñe provisoriamente el Poder Ejecutivo, dentro de los diez días de producida la acefalía definitiva, en los términos del Artículo 91.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '94',
    title: '',
    text: `El Gobernador y el Vicegobernador residirán en la Provincia y no podrán ausentarse de ella sin la correspondiente comunicación a la Legislatura.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '96',
    title: '',
    text: `El Gobernador y Vicegobernador tomarán posesión de sus cargos ante la Legislatura reunida al efecto en sesión especial. En dicha oportunidad prestarán juramento de rigor que respete sus convicciones, jurando sostener y cumplir la Constitución de la Provincia y de la Nación, defender las libertades y derechos garantizados por ambas, ejecutar y hacer ejecutar las leyes sancionadas por la Legislatura de la Provincia y por el Congreso de la Nación, y respetar y hacer respetar a las autoridades de la Provincia y de la Nación.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '97',
    title: '',
    text: `La prohibición de alterar el sueldo, no abarca los ajustes por actualización monetaria que fueran dispuestos con carácter general. No podrá el Gobernador percibir suma alguna por gastos reservados o de cualquier otra naturaleza que no estuvieren sometidos a documentada rendición de cuentas. El Vicegobernador recibirá un sueldo que se regirá por las mismas reglas precedentes.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '98',
    title: '',
    text: `El tratamiento oficial del Gobernador, cuando desempeñe el mando, será de Excelencia. El mismo tratamiento tendrá el Vicegobernador cuando desempeñe el Poder Ejecutivo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '99',
    title: '',
    text: `El Gobernador y el Vicegobernador de la Provincia, serán elegidos directamente por el pueblo de la Provincia en distrito único y a simple pluralidad de sufragios. En caso de empate, decidirá la Legislatura.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '102',
    title: '',
    text: `El Gobernador designa a sus ministros, en el número y con las funciones y competencias propias de cada uno de ellos, de acuerdo lo determine una ley propuesta por el Poder Ejecutivo.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '103',
    title: '',
    text: `Para ser nombrado Ministro se requieren todos los requisitos que esta Constitución determina para ser elegido Legislador.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '105',
    title: '',
    text: `Serán responsables de las órdenes y resoluciones que autoricen, sin que puedan pretender eximirse de responsabilidad por haber procedido en virtud de orden del Gobernador.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '106',
    title: '',
    text: `En los treinta días posteriores a la apertura del período legislativo, los ministros presentarán a la Legislatura una memoria detallada del estado de la Administración en lo relativo a sus respectivos departamentos, indicando en ella las reformas que aconsejen la experiencia y el estudio.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '107',
    title: '',
    text: `Los ministros deben asistir a las sesiones de la Legislatura cuando fuesen llamados por ella; pueden también hacerlo cuando lo crean conveniente y tomar parte en sus discusiones, pero no tendrán voto.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '108',
    title: '',
    text: `Los ministros gozarán por sus servicios de un sueldo establecido por la ley, que no podrá ser alterado durante el tiempo que desempeñen sus funciones. La prohibición de alterar el sueldo, no abarca los ajustes por actualización monetaria que fueran dispuestos con carácter general.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '109',
    title: '',
    text: `El tratamiento de los ministros desempeñando sus funciones, será el de Señoría. Sección V.- Poder Judicial Capítulo Primero.- De su naturaleza y duración`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '110',
    title: '',
    text: `El Poder Judicial de la Provincia será ejercido: por una Corte Suprema y demás tribunales que estableciere la ley.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '111',
    title: '',
    text: `Los Tribunales colegiados elegirán de su seno sus respectivos presidentes, que durarán dos años en sus funciones y serán reelegibles.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '112',
    title: '',
    text: `Los jueces de Corte y demás Tribunales inferiores, los representantes del ministerio fiscal y pupilar, permanecerán en sus cargos mientras dure su buena conducta.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '113',
    title: '',
    text: `Los jueces de todas las instancias y demás funcionarios del artículo anterior serán nombrados por el Poder Ejecutivo con acuerdo de la Legislatura, conforme al procedimiento establecido en el Artículo 101, inciso 5º).`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '114',
    title: '',
    text: `Los jueces de Paz serán nombrados por el Poder Ejecutivo, previo acuerdo de la Corte Suprema. La ley determinará los requisitos que deberán reunir para ser nombrados, el régimen general al que se sujetarán y las causales y procedimiento para su remoción.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '115',
    title: '',
    text: `Los jueces de la Corte Suprema y demás funcionarios judiciales ya mencionados, recibirán una compensación por sus servicios, la que por ningún motivo podrá ser disminuida mientras permanezcan en sus funciones. El retardo en hacer efectiva la compensación, implica disminución de la misma.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '118',
    title: '',
    text: `Los miembros de la Corte Suprema y de los tribunales inferiores no podrán ser legisladores.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '119',
    title: '',
    text: `Al recibirse del cargo los miembros de la Corte Suprema, los jueces, fiscales y defensores, prestarán el mismo juramento que los legisladores. Capítulo Segundo.- Atribuciones y deberes del Poder Judicial`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '121',
    title: '',
    text: `La Corte Suprema ejercerá la superintendencia de la Administración de Justicia y sus facultades en tal carácter serán las que determine la ley.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '122',
    title: '',
    text: `Los tribunales y juzgados de la Provincia en el ejercicio de sus funciones, procederán aplicando esta Constitución y los tratados internacionales como ley suprema respecto a las leyes que haya sancionado o sancionare la Legislatura.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '125',
    title: '',
    text: `Los miembros del Poder Judicial no sometidos a juicio político serán removidos por el Jurado de Enjuiciamiento, por las mismas causas de remoción previstas en el Artículo 47 y las demás que establezca la ley.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '138',
    title: '',
    text: `El Intendente municipal, cuando sea sujeto de actuaciones en sede judicial, tendrá prerrogativas procesales equivalentes a la del titular del Poder Ejecutivo. Los concejales no podrán ser molestados por los dichos emitidos en el seno del recinto.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '140',
    title: '',
    text: `En ejercicio de su autonomía política, las autoridades municipales son jueces naturales de la elección de sus miembros, sin perjuicio de los recursos jurisdiccionales correspondientes.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '141',
    title: '',
    text: `El Gobierno garantizará que las municipalidades ejerzan sus funciones y les prestará los auxilios necesarios para el cumplimiento de sus decisiones cuando ellas se lo demanden. Compete a la Corte Suprema resolver los conflictos de jurisdicción que se suscitaren entre los órganos de un municipio o entre la Provincia y un municipio o entre municipios.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '142',
    title: '',
    text: `El Departamento Ejecutivo Municipal reseñará en una memoria anual sus actividades, la que será girada al Concejo Deliberante.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '143',
    title: '',
    text: `La ley que regule las elecciones municipales, dará el derecho de voto a los extranjeros domiciliados en el municipio, que se inscriban en el padrón que se llevará a esos efectos. Sección VIII Capítulo Primero Educación y Cultura`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '150',
    title: '',
    text: `Esta Constitución podrá ser reformada total o parcialmente por una Convención Constituyente.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '153',
    title: '',
    text: `Determinados por la Legislatura los puntos sobre los que debe versar la reforma y, antes de convocarse al pueblo para la elección de los convencionales que han de verificarla, dichos puntos se publicarán por espacio de dos meses cuanto menos, en los principales periódicos de la Provincia.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '154',
    title: '',
    text: `El número de convencionales será igual al total de legisladores; se elegirán en la misma forma que éstos, de acuerdo al régimen que establezca la ley electoral al momento de la convocatoria; gozarán de las mismas inmunidades mientras ejerzan su mandato y la ley determinará las calidades que deben tener.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '156',
    title: '',
    text: `Esta Constitución no podrá reformarse sino después de dos años desde su aprobación por esta Convención. Sección X.- Disposiciones Transitorias Capítulo Unico`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '157',
    title: '',
    text: `El sistema de votación electrónica establecido en el Artículo 43, inciso 3º), se aplicará en forma progresiva, según lo permitan las exigencias técnicas y económicas que su ejecución demande. La ley reglamentaria del mismo deberá ser aprobada antes de la finalización del año 2006. Mientras tanto, se mantiene el sistema electoral que esta Constitución establece y leyes que reglamenten la materia.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '158',
    title: '',
    text: `Una vez sancionada la reforma, la Legislatura deberá, dentro del plazo de ciento veinte días, dictar la Ley sobre Régimen Electoral y de los Partidos Políticos, de acuerdo a las pautas establecidas por el Artículo 43 de esta Constitución.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '161',
    title: '',
    text: `Hasta tanto se efectúe la renovación total de bancas de la Legislatura en las elecciones del año 2007, a los fines previstos por el Artículo 64, la denegatoria del pedido de desafuero, formulada por juez, deberá ser votada por lo menos por veintiún legisladores.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '162',
    title: '',
    text: `El Poder Ejecutivo, en el plazo de seis meses de sancionada esta Constitución, reglamentará la creación y funcionamiento del Consejo Asesor de la Magistratura.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '163',
    title: '',
    text: `La Legislatura deberá dictar la Ley de Acefalía dentro de los ciento veinte días de sancionada la presente Constitución.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '164',
    title: '',
    text: `Los actuales vocales del Tribunal de Cuentas gozan de la inamovilidad establecida en el Artículo 79.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '165',
    title: '',
    text: `La ley reglamentaria a que se refiere el Artículo 132, segundo párrafo, deberá ser aprobada antes de la finalización del segundo período de sesiones ordinarias, correspondiente al año 2007.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '166',
    title: '',
    text: `El sistema de enmienda prescripto en el Artículo 155 no podrá ser utilizado sino después de dos años de entrar en vigencia la presente Constitución. A estos fines la Legislatura deberá sancionar una ley que reglamente su procedimiento.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '168',
    title: '',
    text: `El texto constitucional provincial ordenado, leído, aprobado y sancionado por esta Convención Constituyente, reemplaza al texto hasta ahora vigente.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
  ...
  },
  {
    ...
    number: '169',
    title: '',
    text: `Las cláusulas transitorias contenidas en el presente texto constitucional, cumplida su finalidad, serán excluidas de las sucesivas publicaciones oficiales.`,
    plainLanguageExplanation: '',
    practicalEffects: [],
    examples: [],
    relatedArticles: [],
