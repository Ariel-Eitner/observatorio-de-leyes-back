...
async function bootstrap() {
	...
	const logLevels: LogLevel[] = isProd ? ['warn', 'error'] : ['log', 'warn', 'error', 'verbose'];
	...
	const CONTENIDO_PUBLICO = /^\/api\/(laws|articles|segments|jurisprudencia|constituciones-provinciales)(\/|$)/;
	...
	const PROD_ORIGINS = ['https://observatorio-de-leyes-front.vercel.app', 'https://observatorio-de-leyes.com'];
